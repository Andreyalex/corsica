...
MySQL - 5.5.43-0ubuntu0.12.04.1 : Database - corsicagallery
*********************************************************************
*/
...
/*Data for the table `cs_address` */

insert  into `cs_address`(`address_id`,`customer_id`,`firstname`,`lastname`,`company`,`address_1`,`address_2`,`city`,`postcode`,`country_id`,`zone_id`,`custom_field`) values (2,2,'avfv','вамв','фукифва','ваифваи','','adfbadf','',220,3485,'a:0:{}'),(8,8,'уцкецуке','','','','','wqetwqerqwr','',0,0,''),(7,7,'user3','','','','','Киев','',0,0,'a:0:{}'),(9,9,'qweqweqw','','','','','ertwertwe','',0,0,'a:0:{}'),(10,10,'qweqweqw','','','','','ertwertwe','',0,0,''),(11,11,'qweqweqw','','','','','ertwertwe','',0,0,''),(12,12,'qweqweqw','','','','','ertwertwe','',0,0,''),(13,13,'qweqweqw','','','','','ertwertwe','',0,0,''),(14,14,'qweqweqw','','','','','ertwertwe','',0,0,''),(15,15,'qweqweqw','','','','','ertwertwe','',0,0,''),(16,16,'qweqweqw','','','','','ertwertwe','',0,0,''),(17,17,'qwewerqwr','','','','','Kiyv','',0,0,''),(18,18,'sawertwert','','','','','ewrtwertwe','',0,0,'');

/*Table structure for table `cs_affiliate` */

DROP TABLE IF EXISTS `cs_affiliate`;

CREATE TABLE `cs_affiliate` (
...
/*Data for the table `cs_affiliate` */

/*Table structure for table `cs_affiliate_activity` */

DROP TABLE IF EXISTS `cs_affiliate_activity`;

CREATE TABLE `cs_affiliate_activity` (
...
/*Data for the table `cs_affiliate_activity` */

/*Table structure for table `cs_affiliate_login` */

DROP TABLE IF EXISTS `cs_affiliate_login`;

CREATE TABLE `cs_affiliate_login` (
...
/*Data for the table `cs_affiliate_login` */

/*Table structure for table `cs_affiliate_transaction` */

DROP TABLE IF EXISTS `cs_affiliate_transaction`;

CREATE TABLE `cs_affiliate_transaction` (
...
/*Data for the table `cs_affiliate_transaction` */

/*Table structure for table `cs_api` */

DROP TABLE IF EXISTS `cs_api`;
...
/*Data for the table `cs_api` */

insert  into `cs_api`(`api_id`,`username`,`firstname`,`lastname`,`password`,`status`,`date_added`,`date_modified`) values (1,'j6urHCz8LrSb3HBGzBTaEmCXOohZZToeLUtHn5lPYymUgNnVm08wx6fkmMhNN07p','','','',1,'2015-04-15 12:31:58','2015-04-15 12:31:58');
...
DROP TABLE IF EXISTS `cs_attribute_description`;

CREATE TABLE `cs_attribute_description` (
...
DROP TABLE IF EXISTS `cs_attribute_group`;

CREATE TABLE `cs_attribute_group` (
  `attribute_group_id` int(11) NOT NULL AUTO_INCREMENT,
  `sort_order` int(3) NOT NULL,
  PRIMARY KEY (`attribute_group_id`)
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;

/*Data for the table `cs_attribute_group` */

insert  into `cs_attribute_group`(`attribute_group_id`,`sort_order`) values (4,1);

/*Table structure for table `cs_attribute_group_description` */

DROP TABLE IF EXISTS `cs_attribute_group_description`;

CREATE TABLE `cs_attribute_group_description` (
  `attribute_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL,
...
DROP TABLE IF EXISTS `cs_banner`;
...
/*Data for the table `cs_banner` */

insert  into `cs_banner`(`banner_id`,`name`,`status`) values (6,'HP Products',1),(7,'Home Page Slideshow',1),(8,'Manufacturers',1);

/*Table structure for table `cs_banner_image` */

DROP TABLE IF EXISTS `cs_banner_image`;

CREATE TABLE `cs_banner_image` (
...
/*Data for the table `cs_banner_image` */

insert  into `cs_banner_image`(`banner_image_id`,`banner_id`,`link`,`image`,`sort_order`) values (79,7,'index.php?route=product/product&amp;path=57&amp;product_id=49','catalog/demo/banners/iPhone6.jpg',0),(87,6,'index.php?route=product/manufacturer/info&amp;manufacturer_id=7','catalog/demo/compaq_presario.jpg',0),(94,8,'','catalog/demo/manufacturer/nfl.png',0),(95,8,'','catalog/demo/manufacturer/redbull.png',0),(96,8,'','catalog/demo/manufacturer/sony.png',0),(91,8,'','catalog/demo/manufacturer/cocacola.png',0),(92,8,'','catalog/demo/manufacturer/burgerking.png',0),(93,8,'','catalog/demo/manufacturer/canon.png',0),(88,8,'','catalog/demo/manufacturer/harley.png',0),(89,8,'','catalog/demo/manufacturer/dell.png',0),(90,8,'','catalog/demo/manufacturer/disney.png',0),(80,7,'','catalog/demo/banners/MacBookAir.jpg',0),(97,8,'','catalog/demo/manufacturer/starbucks.png',0),(98,8,'','catalog/demo/manufacturer/nintendo.png',0);

/*Table structure for table `cs_banner_image_description` */

DROP TABLE IF EXISTS `cs_banner_image_description`;

CREATE TABLE `cs_banner_image_description` (
...
insert  into `cs_category`(`category_id`,`image`,`parent_id`,`top`,`column`,`sort_order`,`status`,`date_added`,`date_modified`) values (59,'catalog/sping-2015/bg-collection.jpg',61,1,1,2,1,'2015-04-15 12:50:48','2015-07-10 23:06:20'),(60,'',0,0,1,0,1,'2015-06-25 23:05:06','2015-06-29 15:03:04'),(61,'',0,0,1,0,1,'2015-06-25 23:06:24','2015-07-02 00:02:55'),(63,'catalog/cloth/Tweed-Coat-Fabrics.jpg',61,0,1,1,1,'2015-07-09 00:07:39','2015-07-09 23:58:55');

/*Table structure for table `cs_category_description` */

DROP TABLE IF EXISTS `cs_category_description`;

CREATE TABLE `cs_category_description` (
...
insert  into `cs_category_description`(`category_id`,`language_id`,`name`,`description`,`meta_title`,`meta_description`,`meta_keyword`) values (59,3,'Весна 2015','&lt;p&gt;&lt;br&gt;&lt;/p&gt;','Весна 2015','',''),(59,2,'Весна 2015','&lt;p&gt;&lt;br&gt;&lt;/p&gt;','Весна 2015','',''),(60,2,'Магазин','&lt;p&gt;&lt;br&gt;&lt;/p&gt;','shop','',''),(61,2,'Коллекции','&lt;p&gt;&lt;br&gt;&lt;/p&gt;','collections','',''),(61,3,'Коллекции','&lt;p&gt;&lt;br&gt;&lt;/p&gt;','collections','',''),(60,1,'Shop','&lt;p&gt;&lt;br&gt;&lt;/p&gt;','shop','',''),(60,3,'Магазин','&lt;p&gt;&lt;br&gt;&lt;/p&gt;','','',''),(59,1,'Spring 2015','&lt;p&gt;&lt;br&gt;&lt;/p&gt;','Spring 2015','',''),(61,1,'Collections','&lt;p&gt;&lt;br&gt;&lt;/p&gt;','collections','',''),(63,1,'Autumn 2014','&lt;p&gt;&lt;br&gt;&lt;/p&gt;','Autumn 2014','',''),(63,2,'Осень 2014','&lt;p&gt;&lt;br&gt;&lt;/p&gt;','Осень 2014','',''),(63,3,'Осінь 2014','&lt;p&gt;&lt;br&gt;&lt;/p&gt;','Осінь 2014','','');

/*Table structure for table `cs_category_filter` */

DROP TABLE IF EXISTS `cs_category_filter`;

CREATE TABLE `cs_category_filter` (
  `category_id` int(11) NOT NULL,
  `filter_id` int(11) NOT NULL,
  PRIMARY KEY (`category_id`,`filter_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

/*Data for the table `cs_category_filter` */

/*Table structure for table `cs_category_path` */

DROP TABLE IF EXISTS `cs_category_path`;

CREATE TABLE `cs_category_path` (
  `category_id` int(11) NOT NULL,
...
/*Data for the table `cs_category_path` */

insert  into `cs_category_path`(`category_id`,`path_id`,`level`) values (59,59,1),(60,60,0),(61,61,0),(59,61,0),(63,61,0),(63,63,1);

/*Table structure for table `cs_category_to_layout` */

DROP TABLE IF EXISTS `cs_category_to_layout`;

CREATE TABLE `cs_category_to_layout` (
  `category_id` int(11) NOT NULL,
...
insert  into `cs_category_to_layout`(`category_id`,`store_id`,`layout_id`) values (59,0,0),(60,0,0),(61,0,0),(61,1,0),(63,0,0);

/*Table structure for table `cs_category_to_store` */

DROP TABLE IF EXISTS `cs_category_to_store`;

CREATE TABLE `cs_category_to_store` (
  `category_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  PRIMARY KEY (`category_id`,`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

/*Data for the table `cs_category_to_store` */

insert  into `cs_category_to_store`(`category_id`,`store_id`) values (59,0),(60,0),(61,0),(63,0);
...
/*Data for the table `cs_coupon_history` */

/*Table structure for table `cs_coupon_product` */

DROP TABLE IF EXISTS `cs_coupon_product`;

CREATE TABLE `cs_coupon_product` (
...
/*Data for the table `cs_coupon_product` */
...
insert  into `cs_currency`(`currency_id`,`title`,`code`,`symbol_left`,`symbol_right`,`decimal_place`,`value`,`status`,`date_modified`) values (2,'US Dollar','USD','','USD','2',1.00000000,1,'2015-07-15 20:35:09'),(4,'Гривна','UAH','','грн','2',22.20000076,0,'2015-07-15 06:40:03');

/*Table structure for table `cs_custom_field` */

DROP TABLE IF EXISTS `cs_custom_field`;

CREATE TABLE `cs_custom_field` (
...
/*Data for the table `cs_custom_field` */

insert  into `cs_custom_field`(`custom_field_id`,`type`,`value`,`location`,`status`,`sort_order`) values (1,'select','','account',1,0);

/*Table structure for table `cs_custom_field_customer_group` */

DROP TABLE IF EXISTS `cs_custom_field_customer_group`;

CREATE TABLE `cs_custom_field_customer_group` (
...
/*Data for the table `cs_custom_field_customer_group` */

insert  into `cs_custom_field_customer_group`(`custom_field_id`,`customer_group_id`,`required`) values (1,1,1);

/*Table structure for table `cs_custom_field_description` */

DROP TABLE IF EXISTS `cs_custom_field_description`;

CREATE TABLE `cs_custom_field_description` (
  `custom_field_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(128) NOT NULL,
...
/*Data for the table `cs_custom_field_description` */

insert  into `cs_custom_field_description`(`custom_field_id`,`language_id`,`name`) values (1,3,'Показувати ціни у колекції'),(1,2,'Отображать ценьі в коллекции'),(1,1,'Show prices in collection');

/*Table structure for table `cs_custom_field_value` */

DROP TABLE IF EXISTS `cs_custom_field_value`;

CREATE TABLE `cs_custom_field_value` (
...
/*Data for the table `cs_custom_field_value` */

insert  into `cs_custom_field_value`(`custom_field_value_id`,`custom_field_id`,`sort_order`) values (2,1,0),(1,1,1);

/*Table structure for table `cs_custom_field_value_description` */

DROP TABLE IF EXISTS `cs_custom_field_value_description`;

CREATE TABLE `cs_custom_field_value_description` (
...
/*Data for the table `cs_custom_field_value_description` */

insert  into `cs_custom_field_value_description`(`custom_field_value_id`,`language_id`,`custom_field_id`,`name`) values (2,1,1,'No'),(2,3,1,'Hi'),(2,2,1,'Нет'),(1,1,1,'Yes'),(1,3,1,'Так'),(1,2,1,'Да');
...
insert  into `cs_customer`(`customer_id`,`customer_group_id`,`store_id`,`firstname`,`lastname`,`email`,`telephone`,`fax`,`password`,`salt`,`cart`,`wishlist`,`newsletter`,`address_id`,`custom_field`,`ip`,`status`,`approved`,`safe`,`token`,`date_added`) values (2,1,0,'test','user','user@host.org','984161','','a0d2fd3e2c0bd482cfa784fb894c77527de05626','624bc7c59','a:1:{s:200:\"YToyOntzOjEwOiJwcm9kdWN0X2lkIjtpOjUwO3M6Njoib3B0aW9uIjthOjM6e2k6MjMwO3M6MjoiMzMiO2k6MjMxO2E6NDp7aTowO3M6MjoiMzQiO2k6MTtzOjI6IjM1IjtpOjI7czoyOiIzNiI7aTozO3M6MjoiMzciO31zOjc6InNpemVzZXQiO3M6MToiNCI7fX0=\";i:1;}','',0,2,'a:1:{i:1;s:1:\"1\";}','127.0.0.1',1,1,0,'','2015-04-16 11:35:28'),(6,1,0,'user2','','qwe@qwe.com','123123123','','50d1c1fcf2396bba8ec900c133932e2980293336','9e9e336ce',NULL,NULL,0,6,'a:1:{i:1;s:1:\"2\";}','127.0.0.1',1,1,1,'','2015-07-04 21:21:02'),(7,1,0,'user3','','user3@host.org','1234567890','','ad344af9a56d7b84b17ad9b5b0c126eece21660f','6248838d2',NULL,NULL,0,7,'a:1:{i:1;s:1:\"1\";}','127.0.0.1',1,0,0,'','2015-07-04 23:01:08'),(8,1,0,'уцкецуке','','qwe@wer.com','234254','','88aba88be4adc75d5874c7aff425fb04656c9744','fc144fc82',NULL,NULL,0,8,'a:1:{i:1;s:1:\"2\";}','127.0.0.1',1,0,0,'','2015-07-05 00:25:34'),(9,1,0,'qweqweqw','','qwer@wer.com','123131313','','933763d034bc262e4af00bd6bb5755bd9cc787d5','0b82db97e',NULL,NULL,0,9,'a:1:{i:1;s:1:\"1\";}','127.0.0.1',1,0,0,'','2015-07-05 00:26:06'),(10,1,0,'qweqweqw','','qwer1@wer.com','123131313','','4bf34b3c334877937bb134fa214b52ca5320b263','3953b330d',NULL,NULL,0,10,'a:1:{i:1;s:1:\"2\";}','127.0.0.1',1,0,0,'','2015-07-05 00:35:28'),(11,1,0,'qweqweqw','','qwer2@wer.com','123131313','','a4381ec2b6ca054599bfe3b2a3bf58c36311828d','b6dcdf221',NULL,NULL,0,11,'a:1:{i:1;s:1:\"2\";}','127.0.0.1',1,0,0,'','2015-07-05 00:46:54'),(12,1,0,'qweqweqw','','qwer4@wer.com','123131313','','b1c998af31f4bf5e47685cc314c47fa365214b74','9a97a6d71',NULL,NULL,0,12,'a:1:{i:1;s:1:\"2\";}','127.0.0.1',1,0,0,'','2015-07-05 00:48:12'),(13,1,0,'qweqweqw','','qwer5@wer.com','123131313','','660960fa77983d5b7ad52c3d39200c0b26bb7540','ecdb537f6',NULL,NULL,0,13,'a:1:{i:1;s:1:\"2\";}','127.0.0.1',1,0,0,'','2015-07-05 00:53:20'),(14,1,0,'qweqweqw','','qwer6@wer.com','123131313','','4bf3a888ac15b0351a08682a26de7c667bdc83fc','c709f143b',NULL,NULL,0,14,'a:1:{i:1;s:1:\"2\";}','127.0.0.1',1,0,0,'','2015-07-05 00:54:35'),(15,1,0,'qweqweqw','','qwer7@wer.com','123131313','','cd7ef7ed15ef8ef9e86d576e2b1a530ed9241eeb','7590aa4a2',NULL,NULL,0,15,'a:1:{i:1;s:1:\"2\";}','127.0.0.1',1,0,0,'','2015-07-05 00:56:45'),(16,1,0,'qweqweqw','','qwer8@wer.com','123131313','','f3ad1c923e20dab5a25c024d733cf4c610b820df','9d77be55b',NULL,NULL,0,16,'a:1:{i:1;s:1:\"2\";}','127.0.0.1',1,0,0,'','2015-07-05 01:00:19'),(17,1,0,'qwewerqwr','','qwe3@qwe.com','123123123','','c470cef95d4a602a6109a2e2cb70d5cd4bead660','07e25e143',NULL,NULL,0,17,'a:1:{i:1;s:1:\"1\";}','127.0.0.1',1,0,0,'','2015-07-06 22:54:49'),(18,1,0,'sawertwert','','werwe@rtewrt.com','12235234523','','9c9bd459d0ae821bed5c58f1969683d832294bee','7e6cad648',NULL,NULL,0,18,'','127.0.0.1',1,0,0,'','2015-07-06 23:08:06');

/*Table structure for table `cs_customer_activity` */

DROP TABLE IF EXISTS `cs_customer_activity`;

CREATE TABLE `cs_customer_activity` (
  `activity_id` int(11) NOT NULL AUTO_INCREMENT,
  `customer_id` int(11) NOT NULL,
  `key` varchar(64) NOT NULL,
  `data` text NOT NULL,
...
insert  into `cs_customer_activity`(`activity_id`,`customer_id`,`key`,`data`,`ip`,`date_added`) values (1,1,'register','a:2:{s:11:\"customer_id\";i:1;s:4:\"name\";s:12:\"dfbd sdfbdsf\";}','127.0.0.1','2015-04-16 10:42:22'),(2,1,'login','a:2:{s:11:\"customer_id\";s:1:\"1\";s:4:\"name\";s:12:\"dfbd sdfbdsf\";}','127.0.0.1','2015-04-16 11:06:17'),(3,2,'register','a:2:{s:11:\"customer_id\";i:2;s:4:\"name\";s:13:\"avfv вамв\";}','127.0.0.1','2015-04-16 11:35:29'),(4,1,'forgotten','a:2:{s:11:\"customer_id\";s:1:\"1\";s:4:\"name\";s:12:\"dfbd sdfbdsf\";}','127.0.0.1','2015-04-16 19:31:07'),(5,2,'forgotten','a:2:{s:11:\"customer_id\";s:1:\"2\";s:4:\"name\";s:13:\"avfv вамв\";}','127.0.0.1','2015-04-16 19:31:31'),(6,2,'login','a:2:{s:11:\"customer_id\";s:1:\"2\";s:4:\"name\";s:9:\"test user\";}','127.0.0.1','2015-04-17 10:40:57'),(7,2,'login','a:2:{s:11:\"customer_id\";s:1:\"2\";s:4:\"name\";s:9:\"test user\";}','46.150.10.185','2015-04-22 13:29:43'),(8,2,'login','a:2:{s:11:\"customer_id\";s:1:\"2\";s:4:\"name\";s:9:\"test user\";}','109.87.92.170','2015-04-23 10:21:48'),(9,2,'login','a:2:{s:11:\"customer_id\";s:1:\"2\";s:4:\"name\";s:9:\"test user\";}','178.165.126.50','2015-05-22 17:54:53'),(10,2,'login','a:2:{s:11:\"customer_id\";s:1:\"2\";s:4:\"name\";s:9:\"test user\";}','46.150.10.185','2015-05-27 11:57:46'),(11,2,'login','a:2:{s:11:\"customer_id\";s:1:\"2\";s:4:\"name\";s:9:\"test user\";}','46.150.2.172','2015-06-16 15:49:21'),(12,2,'login','a:2:{s:11:\"customer_id\";s:1:\"2\";s:4:\"name\";s:9:\"test user\";}','46.150.2.172','2015-06-16 16:24:16'),(13,2,'login','a:2:{s:11:\"customer_id\";s:1:\"2\";s:4:\"name\";s:9:\"test user\";}','46.150.2.172','2015-06-16 16:31:24'),(14,2,'password','a:2:{s:11:\"customer_id\";s:1:\"2\";s:4:\"name\";s:9:\"test user\";}','127.0.0.1','2015-06-25 18:49:39'),(15,2,'login','a:2:{s:11:\"customer_id\";s:1:\"2\";s:4:\"name\";s:9:\"test user\";}','127.0.0.1','2015-07-01 22:12:35'),(16,2,'login','a:2:{s:11:\"customer_id\";s:1:\"2\";s:4:\"name\";s:9:\"test user\";}','127.0.0.1','2015-07-01 22:13:01'),(17,2,'login','a:2:{s:11:\"customer_id\";s:1:\"2\";s:4:\"name\";s:9:\"test user\";}','127.0.0.1','2015-07-01 22:13:24'),(18,2,'login','a:2:{s:11:\"customer_id\";s:1:\"2\";s:4:\"name\";s:9:\"test user\";}','127.0.0.1','2015-07-03 17:11:11'),(19,2,'login','a:2:{s:11:\"customer_id\";s:1:\"2\";s:4:\"name\";s:9:\"test user\";}','127.0.0.1','2015-07-03 17:12:41'),(20,2,'login','a:2:{s:11:\"customer_id\";s:1:\"2\";s:4:\"name\";s:9:\"test user\";}','127.0.0.1','2015-07-03 22:26:21'),(21,2,'login','a:2:{s:11:\"customer_id\";s:1:\"2\";s:4:\"name\";s:9:\"test user\";}','127.0.0.1','2015-07-03 23:17:24'),(22,2,'login','a:2:{s:11:\"customer_id\";s:1:\"2\";s:4:\"name\";s:9:\"test user\";}','127.0.0.1','2015-07-04 17:06:48'),(23,2,'login','a:2:{s:11:\"customer_id\";s:1:\"2\";s:4:\"name\";s:9:\"test user\";}','127.0.0.1','2015-07-04 18:26:50'),(24,3,'register','a:2:{s:11:\"customer_id\";i:3;s:4:\"name\";s:13:\"wertwe ertwet\";}','127.0.0.1','2015-07-04 18:54:55'),(25,0,'order_guest','a:2:{s:4:\"name\";s:16:\"ertwertwer twert\";s:8:\"order_id\";i:1;}','127.0.0.1','2015-07-04 18:58:33'),(26,2,'login','a:2:{s:11:\"customer_id\";s:1:\"2\";s:4:\"name\";s:9:\"test user\";}','127.0.0.1','2015-07-04 19:02:28'),(27,4,'register','a:2:{s:11:\"customer_id\";i:4;s:4:\"name\";s:15:\"цукцукц \";}','127.0.0.1','2015-07-04 20:43:28'),(28,5,'register','a:2:{s:11:\"customer_id\";i:5;s:4:\"name\";s:9:\"wqerqwer \";}','127.0.0.1','2015-07-04 21:16:10'),(29,6,'register','a:2:{s:11:\"customer_id\";i:6;s:4:\"name\";s:6:\"user2 \";}','127.0.0.1','2015-07-04 21:21:02'),(30,7,'register','a:2:{s:11:\"customer_id\";i:7;s:4:\"name\";s:6:\"user3 \";}','127.0.0.1','2015-07-04 23:01:08'),(31,8,'register','a:2:{s:11:\"customer_id\";i:8;s:4:\"name\";s:17:\"уцкецуке \";}','127.0.0.1','2015-07-05 00:25:34'),(32,12,'register','a:2:{s:11:\"customer_id\";i:12;s:4:\"name\";s:9:\"qweqweqw \";}','127.0.0.1','2015-07-05 00:49:35'),(33,16,'register','a:2:{s:11:\"customer_id\";i:16;s:4:\"name\";s:9:\"qweqweqw \";}','127.0.0.1','2015-07-05 01:00:19'),(34,2,'login','a:2:{s:11:\"customer_id\";s:1:\"2\";s:4:\"name\";s:9:\"test user\";}','127.0.0.1','2015-07-05 01:03:32'),(35,2,'login','a:2:{s:11:\"customer_id\";s:1:\"2\";s:4:\"name\";s:9:\"test user\";}','127.0.0.1','2015-07-05 01:04:22'),(36,2,'login','a:2:{s:11:\"customer_id\";s:1:\"2\";s:4:\"name\";s:9:\"test user\";}','127.0.0.1','2015-07-05 01:08:42'),(37,2,'login','a:2:{s:11:\"customer_id\";s:1:\"2\";s:4:\"name\";s:9:\"test user\";}','127.0.0.1','2015-07-05 01:15:43'),(38,2,'login','a:2:{s:11:\"customer_id\";s:1:\"2\";s:4:\"name\";s:9:\"test user\";}','127.0.0.1','2015-07-05 01:16:58'),(39,2,'login','a:2:{s:11:\"customer_id\";s:1:\"2\";s:4:\"name\";s:9:\"test user\";}','127.0.0.1','2015-07-05 01:18:00'),(40,2,'login','a:2:{s:11:\"customer_id\";s:1:\"2\";s:4:\"name\";s:9:\"test user\";}','127.0.0.1','2015-07-05 01:18:42'),(41,2,'login','a:2:{s:11:\"customer_id\";s:1:\"2\";s:4:\"name\";s:9:\"test user\";}','127.0.0.1','2015-07-05 01:19:27'),(42,2,'login','a:2:{s:11:\"customer_id\";s:1:\"2\";s:4:\"name\";s:9:\"test user\";}','127.0.0.1','2015-07-05 20:52:25'),(43,2,'login','a:2:{s:11:\"customer_id\";s:1:\"2\";s:4:\"name\";s:9:\"test user\";}','127.0.0.1','2015-07-06 22:47:19'),(44,2,'login','a:2:{s:11:\"customer_id\";s:1:\"2\";s:4:\"name\";s:9:\"test user\";}','127.0.0.1','2015-07-06 22:49:56'),(45,17,'register','a:2:{s:11:\"customer_id\";i:17;s:4:\"name\";s:10:\"qwewerqwr \";}','127.0.0.1','2015-07-06 22:54:49'),(46,18,'register','a:2:{s:11:\"customer_id\";i:18;s:4:\"name\";s:11:\"sawertwert \";}','127.0.0.1','2015-07-06 23:08:06'),(47,2,'login','a:2:{s:11:\"customer_id\";s:1:\"2\";s:4:\"name\";s:9:\"test user\";}','127.0.0.1','2015-07-06 23:16:09'),(48,2,'login','a:2:{s:11:\"customer_id\";s:1:\"2\";s:4:\"name\";s:9:\"test user\";}','127.0.0.1','2015-07-06 23:17:39'),(49,2,'login','a:2:{s:11:\"customer_id\";s:1:\"2\";s:4:\"name\";s:9:\"test user\";}','127.0.0.1','2015-07-07 00:28:00'),(50,2,'login','a:2:{s:11:\"customer_id\";s:1:\"2\";s:4:\"name\";s:9:\"test user\";}','127.0.0.1','2015-07-07 22:25:46'),(51,2,'login','a:2:{s:11:\"customer_id\";s:1:\"2\";s:4:\"name\";s:9:\"test user\";}','127.0.0.1','2015-07-07 22:39:08'),(52,2,'order_account','a:3:{s:11:\"customer_id\";s:1:\"2\";s:4:\"name\";s:9:\"test user\";s:8:\"order_id\";i:4;}','127.0.0.1','2015-07-07 22:44:58'),(53,0,'order_guest','a:2:{s:4:\"name\";s:7:\"Имя \";s:8:\"order_id\";i:7;}','127.0.0.1','2015-07-07 22:58:18'),(54,2,'login','a:2:{s:11:\"customer_id\";s:1:\"2\";s:4:\"name\";s:9:\"test user\";}','127.0.0.1','2015-07-07 22:59:40'),(55,2,'order_account','a:3:{s:11:\"customer_id\";s:1:\"2\";s:4:\"name\";s:9:\"test user\";s:8:\"order_id\";i:8;}','127.0.0.1','2015-07-07 22:59:54'),(56,2,'order_account','a:3:{s:11:\"customer_id\";s:1:\"2\";s:4:\"name\";s:9:\"test user\";s:8:\"order_id\";i:11;}','127.0.0.1','2015-07-07 23:14:40'),(57,2,'order_account','a:3:{s:11:\"customer_id\";s:1:\"2\";s:4:\"name\";s:9:\"test user\";s:8:\"order_id\";i:13;}','127.0.0.1','2015-07-07 23:50:51'),(58,2,'login','a:2:{s:11:\"customer_id\";s:1:\"2\";s:4:\"name\";s:9:\"test user\";}','127.0.0.1','2015-07-08 00:14:47'),(59,2,'login','a:2:{s:11:\"customer_id\";s:1:\"2\";s:4:\"name\";s:9:\"test user\";}','127.0.0.1','2015-07-08 23:09:07'),(60,2,'login','a:2:{s:11:\"customer_id\";s:1:\"2\";s:4:\"name\";s:9:\"test user\";}','127.0.0.1','2015-07-10 00:01:43'),(61,2,'login','a:2:{s:11:\"customer_id\";s:1:\"2\";s:4:\"name\";s:9:\"test user\";}','127.0.0.1','2015-07-10 21:20:30'),(62,2,'login','a:2:{s:11:\"customer_id\";s:1:\"2\";s:4:\"name\";s:9:\"test user\";}','127.0.0.1','2015-07-10 23:00:25'),(63,0,'order_guest','a:2:{s:4:\"name\";s:13:\"Андрей \";s:8:\"order_id\";i:15;}','37.57.25.26','2015-07-16 00:23:34'),(64,0,'order_guest','a:2:{s:4:\"name\";s:9:\"Вася \";s:8:\"order_id\";i:16;}','37.57.25.26','2015-07-16 00:34:07'),(65,0,'order_guest','a:2:{s:4:\"name\";s:26:\"Ключко Андрей \";s:8:\"order_id\";i:17;}','37.57.25.26','2015-07-16 01:01:05');

/*Table structure for table `cs_customer_ban_ip` */

DROP TABLE IF EXISTS `cs_customer_ban_ip`;

CREATE TABLE `cs_customer_ban_ip` (
...
/*Data for the table `cs_customer_ban_ip` */

/*Table structure for table `cs_customer_group` */
...
/*Data for the table `cs_customer_group` */

insert  into `cs_customer_group`(`customer_group_id`,`approval`,`sort_order`) values (1,1,1);

/*Table structure for table `cs_customer_group_description` */

DROP TABLE IF EXISTS `cs_customer_group_description`;

CREATE TABLE `cs_customer_group_description` (
  `customer_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `cs_customer_history`;

CREATE TABLE `cs_customer_history` (
...
/*Data for the table `cs_customer_history` */

/*Table structure for table `cs_customer_ip` */

DROP TABLE IF EXISTS `cs_customer_ip`;

CREATE TABLE `cs_customer_ip` (
...
/*Data for the table `cs_customer_ip` */

insert  into `cs_customer_ip`(`customer_ip_id`,`customer_id`,`ip`,`date_added`) values (2,2,'127.0.0.1','2015-04-17 10:40:57'),(3,2,'46.150.10.185','2015-04-22 13:29:43'),(4,2,'109.87.92.170','2015-04-23 10:21:48'),(5,2,'178.165.126.50','2015-05-22 17:54:53'),(6,2,'46.150.2.172','2015-06-16 15:49:21');

/*Table structure for table `cs_customer_login` */

DROP TABLE IF EXISTS `cs_customer_login`;

CREATE TABLE `cs_customer_login` (
...
/*Data for the table `cs_customer_login` */

insert  into `cs_customer_login`(`customer_login_id`,`email`,`ip`,`total`,`date_added`,`date_modified`) values (1,'','127.0.0.1',7,'2015-04-16 10:06:42','2015-04-16 18:22:44'),(2,'test','127.0.0.1',1,'2015-04-17 09:40:47','2015-04-17 09:40:47'),(3,'','109.87.92.170',1,'2015-04-23 10:15:36','2015-04-23 10:15:36'),(5,'','46.150.2.172',1,'2015-06-16 15:47:41','2015-06-16 15:47:41'),(6,'user@test.org','46.150.2.172',4,'2015-06-16 15:48:23','2015-06-16 15:49:12'),(7,'user3@host.org','127.0.0.1',1,'2015-07-04 20:05:03','2015-07-04 20:05:03');

/*Table structure for table `cs_customer_online` */

DROP TABLE IF EXISTS `cs_customer_online`;

CREATE TABLE `cs_customer_online` (
  `ip` varchar(40) NOT NULL,
  `customer_id` int(11) NOT NULL,
  `url` text NOT NULL,
...
/*Data for the table `cs_customer_online` */

/*Table structure for table `cs_customer_reward` */

DROP TABLE IF EXISTS `cs_customer_reward`;

CREATE TABLE `cs_customer_reward` (
...
/*Data for the table `cs_customer_reward` */

/*Table structure for table `cs_customer_transaction` */

DROP TABLE IF EXISTS `cs_customer_transaction`;

CREATE TABLE `cs_customer_transaction` (
...
/*Data for the table `cs_customer_transaction` */

/*Table structure for table `cs_download` */

DROP TABLE IF EXISTS `cs_download`;

CREATE TABLE `cs_download` (
...
/*Data for the table `cs_download` */

/*Table structure for table `cs_download_description` */

DROP TABLE IF EXISTS `cs_download_description`;

CREATE TABLE `cs_download_description` (
...
/*Data for the table `cs_download_description` */
...
/*Data for the table `cs_event` */

/*Table structure for table `cs_extension` */

DROP TABLE IF EXISTS `cs_extension`;

CREATE TABLE `cs_extension` (
...
/*Data for the table `cs_extension` */

insert  into `cs_extension`(`extension_id`,`type`,`code`) values (22,'total','shipping'),(57,'total','sub_total'),(58,'total','tax'),(59,'total','total'),(390,'total','credit'),(430,'payment','bank_transfer'),(349,'total','handling'),(350,'total','low_order_fee'),(389,'total','coupon'),(393,'total','reward'),(398,'total','voucher'),(428,'payment','cod');

/*Table structure for table `cs_filter` */

DROP TABLE IF EXISTS `cs_filter`;

CREATE TABLE `cs_filter` (
...
/*Data for the table `cs_filter` */

insert  into `cs_filter`(`filter_id`,`filter_group_id`,`sort_order`) values (1,1,0);

/*Table structure for table `cs_filter_description` */

DROP TABLE IF EXISTS `cs_filter_description`;

CREATE TABLE `cs_filter_description` (
  `filter_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `filter_group_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL,
...
/*Data for the table `cs_filter_description` */

insert  into `cs_filter_description`(`filter_id`,`language_id`,`filter_group_id`,`name`) values (1,1,1,'1'),(1,2,1,'1'),(1,3,1,'1');

/*Table structure for table `cs_filter_group` */

DROP TABLE IF EXISTS `cs_filter_group`;

CREATE TABLE `cs_filter_group` (
  `filter_group_id` int(11) NOT NULL AUTO_INCREMENT,
  `sort_order` int(3) NOT NULL,
  PRIMARY KEY (`filter_group_id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

/*Data for the table `cs_filter_group` */

insert  into `cs_filter_group`(`filter_group_id`,`sort_order`) values (1,0);

/*Table structure for table `cs_filter_group_description` */

DROP TABLE IF EXISTS `cs_filter_group_description`;

CREATE TABLE `cs_filter_group_description` (
  `filter_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL,
...
/*Data for the table `cs_filter_group_description` */

insert  into `cs_filter_group_description`(`filter_group_id`,`language_id`,`name`) values (1,1,'Фильтр1'),(1,2,'Фильтр1'),(1,3,'Фильтр1');

/*Table structure for table `cs_geo_zone` */

DROP TABLE IF EXISTS `cs_geo_zone`;

CREATE TABLE `cs_geo_zone` (
...
/*Data for the table `cs_geo_zone` */

insert  into `cs_geo_zone`(`geo_zone_id`,`name`,`description`,`date_modified`,`date_added`) values (3,'UK VAT Zone','UK VAT','2010-02-26 22:33:24','2009-01-06 23:26:25'),(4,'UK Shipping','UK Shipping Zones','2010-12-15 15:18:13','2009-06-23 01:14:53');

/*Table structure for table `cs_information` */

DROP TABLE IF EXISTS `cs_information`;

CREATE TABLE `cs_information` (
...
/*Data for the table `cs_information` */

insert  into `cs_information`(`information_id`,`bottom`,`sort_order`,`status`) values (4,0,1,1);

/*Table structure for table `cs_information_description` */

DROP TABLE IF EXISTS `cs_information_description`;

CREATE TABLE `cs_information_description` (
...
/*Data for the table `cs_information_description` */

insert  into `cs_information_description`(`information_id`,`language_id`,`title`,`description`,`meta_title`,`meta_description`,`meta_keyword`) values (4,2,'О нас','&lt;p&gt;\r\n	О нас&lt;/p&gt;\r\n','О нас','',''),(4,1,'About Us','&lt;p&gt;\r\n	About Us&lt;/p&gt;\r\n','About Us','',''),(4,3,'О нас','&lt;p&gt;\r\n	О нас&lt;/p&gt;\r\n','','','');

/*Table structure for table `cs_information_to_layout` */

DROP TABLE IF EXISTS `cs_information_to_layout`;

CREATE TABLE `cs_information_to_layout` (
  `information_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL,
...
/*Data for the table `cs_information_to_layout` */

insert  into `cs_information_to_layout`(`information_id`,`store_id`,`layout_id`) values (4,0,0);

/*Table structure for table `cs_information_to_store` */

DROP TABLE IF EXISTS `cs_information_to_store`;

CREATE TABLE `cs_information_to_store` (
  `information_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  PRIMARY KEY (`information_id`,`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

/*Data for the table `cs_information_to_store` */

insert  into `cs_information_to_store`(`information_id`,`store_id`) values (4,0);

/*Table structure for table `cs_language` */

DROP TABLE IF EXISTS `cs_language`;

CREATE TABLE `cs_language` (
...
/*Data for the table `cs_language` */

insert  into `cs_language`(`language_id`,`name`,`code`,`locale`,`image`,`directory`,`sort_order`,`status`) values (1,'English','en','en_US.UTF-8,en_US,en-gb,english','gb.png','english',3,1),(2,'Russian','ru','ru_RU.UTF-8,ru_RU,russian','ru.png','russian',1,1),(3,'Ukrainian','ua','ua_UA.UTF-8,ua_UA,ua-ua,ukrainian','ua.png','ukrainian',2,1);

/*Table structure for table `cs_layout` */

DROP TABLE IF EXISTS `cs_layout`;

CREATE TABLE `cs_layout` (
  `layout_id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(64) NOT NULL,
  PRIMARY KEY (`layout_id`)
) ENGINE=MyISAM AUTO_INCREMENT=14 DEFAULT CHARSET=utf8;

/*Data for the table `cs_layout` */

insert  into `cs_layout`(`layout_id`,`name`) values (1,'Home'),(2,'Product'),(3,'Category'),(4,'Default'),(5,'Manufacturer'),(6,'Account'),(7,'Checkout'),(8,'Contact'),(9,'Sitemap'),(10,'Affiliate'),(11,'Information'),(12,'Compare'),(13,'Search');

/*Table structure for table `cs_layout_module` */

DROP TABLE IF EXISTS `cs_layout_module`;

CREATE TABLE `cs_layout_module` (
...
/*Data for the table `cs_layout_module` */

insert  into `cs_layout_module`(`layout_module_id`,`layout_id`,`code`,`position`,`sort_order`) values (2,4,'0','content_top',0),(3,4,'0','content_top',1),(20,5,'0','column_left',2),(69,10,'affiliate','column_right',1);

/*Table structure for table `cs_layout_route` */

DROP TABLE IF EXISTS `cs_layout_route`;

CREATE TABLE `cs_layout_route` (
...
DROP TABLE IF EXISTS `cs_length_class`;

CREATE TABLE `cs_length_class` (
  `length_class_id` int(11) NOT NULL AUTO_INCREMENT,
  `value` decimal(15,8) NOT NULL,
  PRIMARY KEY (`length_class_id`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;

/*Data for the table `cs_length_class` */

insert  into `cs_length_class`(`length_class_id`,`value`) values (1,'1.00000000'),(2,'10.00000000'),(3,'0.39370000');

/*Table structure for table `cs_length_class_description` */

DROP TABLE IF EXISTS `cs_length_class_description`;

CREATE TABLE `cs_length_class_description` (
  `length_class_id` int(11) NOT NULL AUTO_INCREMENT,
  `language_id` int(11) NOT NULL,
  `title` varchar(32) NOT NULL,
...
/*Data for the table `cs_length_class_description` */

insert  into `cs_length_class_description`(`length_class_id`,`language_id`,`title`,`unit`) values (1,1,'Centimeter','cm'),(2,1,'Millimeter','mm'),(3,1,'Inch','in'),(1,2,'Centimeter','cm'),(2,2,'Millimeter','mm'),(3,2,'Inch','in'),(1,3,'Centimeter','cm'),(2,3,'Millimeter','mm'),(3,3,'Inch','in');

/*Table structure for table `cs_location` */

DROP TABLE IF EXISTS `cs_location`;

CREATE TABLE `cs_location` (
...
/*Data for the table `cs_location` */

/*Table structure for table `cs_manufacturer` */

DROP TABLE IF EXISTS `cs_manufacturer`;
...
/*Data for the table `cs_manufacturer` */

insert  into `cs_manufacturer`(`manufacturer_id`,`name`,`image`,`sort_order`) values (5,'HTC','catalog/demo/htc_logo.jpg',0),(6,'Palm','catalog/demo/palm_logo.jpg',0),(7,'Hewlett-Packard','catalog/demo/hp_logo.jpg',0),(8,'Apple','catalog/demo/apple_logo.jpg',0),(9,'Canon','catalog/demo/canon_logo.jpg',0),(10,'Sony','catalog/demo/sony_logo.jpg',0);

/*Table structure for table `cs_manufacturer_to_store` */

DROP TABLE IF EXISTS `cs_manufacturer_to_store`;

CREATE TABLE `cs_manufacturer_to_store` (
  `manufacturer_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  PRIMARY KEY (`manufacturer_id`,`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

/*Data for the table `cs_manufacturer_to_store` */

insert  into `cs_manufacturer_to_store`(`manufacturer_id`,`store_id`) values (5,0),(6,0),(7,0),(8,0),(9,0),(10,0);

/*Table structure for table `cs_marketing` */

DROP TABLE IF EXISTS `cs_marketing`;

CREATE TABLE `cs_marketing` (
...
/*Data for the table `cs_marketing` */

/*Table structure for table `cs_modification` */

DROP TABLE IF EXISTS `cs_modification`;

CREATE TABLE `cs_modification` (
...
/*Data for the table `cs_modification` */

/*Table structure for table `cs_module` */

DROP TABLE IF EXISTS `cs_module`;
...
/*Data for the table `cs_module` */

/*Table structure for table `cs_option` */
...
DROP TABLE IF EXISTS `cs_option_description`;

CREATE TABLE `cs_option_description` (
...
insert  into `cs_option_description`(`option_id`,`language_id`,`name`) values (1,2,'Цвет'),(11,3,'Розмір'),(1,1,'Color'),(11,1,'Size'),(1,3,'Колір'),(11,2,'Размер');

/*Table structure for table `cs_option_value` */

DROP TABLE IF EXISTS `cs_option_value`;

CREATE TABLE `cs_option_value` (
...
insert  into `cs_option_value`(`option_value_id`,`option_id`,`image`,`sort_order`) values (32,1,'catalog/cloth/tweed-fabric-for-made-to-measure-coat.jpg',4),(31,1,'',3),(50,11,'',4),(48,11,'',3),(47,11,'',2),(43,1,'catalog/cloth/Tweed-Coat-Fabrics.jpg',2),(46,11,'',1),(51,11,'',5),(52,11,'',6),(49,1,'',1),(53,11,'',7);

/*Table structure for table `cs_option_value_description` */

DROP TABLE IF EXISTS `cs_option_value_description`;

CREATE TABLE `cs_option_value_description` (
...
insert  into `cs_option_value_description`(`option_value_id`,`language_id`,`option_id`,`name`) values (32,3,1,'Чорний'),(32,1,1,'Black'),(50,1,11,'46'),(50,3,11,'46'),(31,1,1,'Red'),(50,2,11,'46'),(48,1,11,'44'),(48,3,11,'44'),(47,1,11,'42'),(48,2,11,'44'),(47,3,11,'42'),(47,2,11,'42'),(46,1,11,'40'),(32,2,1,'Черньій'),(43,1,1,'Gold'),(31,2,1,'Красньій'),(46,3,11,'40'),(46,2,11,'40'),(51,1,11,'48'),(51,2,11,'48'),(51,3,11,'48'),(52,1,11,'50'),(52,3,11,'50'),(52,2,11,'50'),(31,3,1,'Червоний'),(43,3,1,'Золотий'),(43,2,1,'Золотой'),(49,1,1,'White'),(49,3,1,'Білий'),(49,2,1,'Бельій'),(53,1,11,'52'),(53,3,11,'52'),(53,2,11,'52');
...
/*Data for the table `cs_order` */

insert  into `cs_order`(`order_id`,`invoice_no`,`invoice_prefix`,`store_id`,`store_name`,`store_url`,`customer_id`,`customer_group_id`,`firstname`,`lastname`,`email`,`telephone`,`fax`,`custom_field`,`payment_firstname`,`payment_lastname`,`payment_company`,`payment_address_1`,`payment_address_2`,`payment_city`,`payment_postcode`,`payment_country`,`payment_country_id`,`payment_zone`,`payment_zone_id`,`payment_address_format`,`payment_custom_field`,`payment_method`,`payment_code`,`shipping_firstname`,`shipping_lastname`,`shipping_company`,`shipping_address_1`,`shipping_address_2`,`shipping_city`,`shipping_postcode`,`shipping_country`,`shipping_country_id`,`shipping_zone`,`shipping_zone_id`,`shipping_address_format`,`shipping_custom_field`,`shipping_method`,`shipping_code`,`comment`,`total`,`order_status_id`,`affiliate_id`,`commission`,`marketing_id`,`tracking`,`language_id`,`currency_id`,`currency_code`,`currency_value`,`ip`,`forwarded_ip`,`user_agent`,`accept_language`,`date_added`,`date_modified`) values (9,0,'INV-2013-00',0,'corsica.com.ua','http://corsica.loc/',2,1,'test','user','user@host.org','984161','','a:1:{i:1;s:1:\"1\";}','test','','','','','','','',0,'',0,'','a:0:{}','Банковский перевод','bank_transfer','avfv','вамв','фукифва','ваифваи','','adfbadf','','Ukraine',220,'Donets\'ka Oblast\'',3485,'','a:0:{}','','','Выберите способ оплаты для данного заказа','56756.0000',0,0,'0.0000',0,'',2,2,'USD','1.00000000','127.0.0.1','','Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36','en-US,en;q=0.8,de;q=0.6,pl;q=0.4,ru;q=0.2,sv;q=0.2,uk;q=0.2,tr;q=0.2','2015-07-07 23:10:43','2015-07-07 23:10:43'),(2,0,'INV-2013-00',0,'corsica.com.ua','http://corsica.loc/',2,1,'test','user','user@host.org','984161','','a:1:{i:1;s:1:\"1\";}','wetrwerwer','','','','','','','',0,'',0,'','a:0:{}','Оплата наличными','cheque','avfv','вамв','фукифва','ваифваи','','adfbadf','','Ukraine',220,'Donets\'ka Oblast\'',3485,'','a:0:{}','','','','133769.0000',0,0,'0.0000',0,'',2,2,'USD','1.00000000','127.0.0.1','','Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36','en-US,en;q=0.8,de;q=0.6,pl;q=0.4,ru;q=0.2,sv;q=0.2,uk;q=0.2,tr;q=0.2','2015-07-07 22:42:07','2015-07-07 22:42:07'),(3,0,'INV-2013-00',0,'corsica.com.ua','http://corsica.loc/',2,1,'test','user','user@host.org','984161','','a:1:{i:1;s:1:\"1\";}','wetrwerwer','','','','','','','',0,'',0,'','a:0:{}','Оплата при доставке','cod','avfv','вамв','фукифва','ваифваи','','adfbadf','','Ukraine',220,'Donets\'ka Oblast\'',3485,'','a:0:{}','','','','133769.0000',0,0,'0.0000',0,'',2,2,'USD','1.00000000','127.0.0.1','','Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36','en-US,en;q=0.8,de;q=0.6,pl;q=0.4,ru;q=0.2,sv;q=0.2,uk;q=0.2,tr;q=0.2','2015-07-07 22:42:38','2015-07-07 22:42:38'),(10,0,'INV-2013-00',0,'corsica.com.ua','http://corsica.loc/',2,1,'test','user','user@host.org','984161','','a:1:{i:1;s:1:\"1\";}','test','','','','','','','',0,'',0,'','a:0:{}','Банковский перевод','bank_transfer','avfv','вамв','фукифва','ваифваи','','adfbadf','','Ukraine',220,'Donets\'ka Oblast\'',3485,'','a:0:{}','','','Выберите способ оплаты для данного заказа','56756.0000',0,0,'0.0000',0,'',2,2,'USD','1.00000000','127.0.0.1','','Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36','en-US,en;q=0.8,de;q=0.6,pl;q=0.4,ru;q=0.2,sv;q=0.2,uk;q=0.2,tr;q=0.2','2015-07-07 23:12:13','2015-07-07 23:12:13'),(5,0,'INV-2013-00',0,'corsica.com.ua','http://corsica.loc/',0,1,'Имя','','email@host.org','345234634563456','','a:0:{}','Имя','','','','','Город','','',0,'',0,'','a:0:{}','Банковский перевод','bank_transfer','','','','','','','','',0,'',0,'','a:0:{}','','','Вы можете добавить комментарий к своему заказу\n','145.0000',0,0,'0.0000',0,'',2,2,'USD','1.00000000','127.0.0.1','','Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36','en-US,en;q=0.8,de;q=0.6,pl;q=0.4,ru;q=0.2,sv;q=0.2,uk;q=0.2,tr;q=0.2','2015-07-07 22:57:08','2015-07-07 22:57:08'),(6,0,'INV-2013-00',0,'corsica.com.ua','http://corsica.loc/',0,1,'Имя','','email@host.org','345234634563456','','a:0:{}','Имя','','','','','Город','','',0,'',0,'','a:0:{}','Банковский перевод','bank_transfer','Имя','','','','','Город','','',0,'',0,'','a:0:{}','','','Вы можете добавить комментарий к своему заказу\n','145.0000',0,0,'0.0000',0,'',2,2,'USD','1.00000000','127.0.0.1','','Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36','en-US,en;q=0.8,de;q=0.6,pl;q=0.4,ru;q=0.2,sv;q=0.2,uk;q=0.2,tr;q=0.2','2015-07-07 22:57:54','2015-07-07 22:57:54'),(15,0,'INV-2013-00',0,'corsica.com.ua','http://corsicagallery.com/',0,1,'Андрей','','woody@nixsolutions.com','1234567890','','a:0:{}','Андрей','','','','','Харьков','','',0,'',0,'','a:0:{}','Оплата при доставке','cod','Андрей','','','','','Харьков','','',0,'',0,'','a:0:{}','','','Вы можете добавить комментарий к своему заказу','678.0000',2,0,'0.0000',0,'',2,2,'USD','1.00000000','37.57.25.26','','Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.132 Safari/537.36','en-US,en;q=0.8,de;q=0.6,pl;q=0.4,ru;q=0.2,sv;q=0.2,uk;q=0.2,tr;q=0.2','2015-07-16 00:23:32','2015-07-16 00:23:34'),(12,0,'INV-2013-00',0,'corsica.com.ua','http://corsica.loc/',2,1,'test','user','user@host.org','984161','','a:1:{i:1;s:1:\"1\";}','test','','','','','','','',0,'',0,'','a:0:{}','Банковский перевод','bank_transfer','','','','','','','','',0,'',0,'','a:0:{}','','','','492.0000',0,0,'0.0000',0,'',2,2,'USD','1.00000000','127.0.0.1','','Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36','en-US,en;q=0.8,de;q=0.6,pl;q=0.4,ru;q=0.2,sv;q=0.2,uk;q=0.2,tr;q=0.2','2015-07-07 23:48:47','2015-07-07 23:48:47'),(16,0,'INV-2013-00',0,'corsica.com.ua','http://corsicagallery.com/',0,1,'Вася','','woody@nixsolutions.com','2345234523523','','a:0:{}','Вася','','','','','Харьков','','',0,'',0,'','a:0:{}','Банковский перевод','bank_transfer','Андрей','','','','','Харьков','','',0,'',0,'','a:0:{}','','','Вы можете добавить комментарий к своему заказу','145.0000',7,0,'0.0000',0,'',2,2,'USD','1.00000000','37.57.25.26','','Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.132 Safari/537.36','en-US,en;q=0.8,de;q=0.6,pl;q=0.4,ru;q=0.2,sv;q=0.2,uk;q=0.2,tr;q=0.2','2015-07-16 00:34:02','2015-07-16 00:34:04'),(14,0,'INV-2013-00',0,'corsica.com.ua','http://corsica.loc/',2,1,'test','user','user@host.org','984161','','a:1:{i:1;s:1:\"1\";}','test','','','','','','','',0,'',0,'','a:0:{}','Банковский перевод','bank_transfer','','','','','','','','',0,'',0,'','a:0:{}','','','','492.0000',0,0,'0.0000',0,'',2,2,'USD','1.00000000','127.0.0.1','','Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36','en-US,en;q=0.8,de;q=0.6,pl;q=0.4,ru;q=0.2,sv;q=0.2,uk;q=0.2,tr;q=0.2','2015-07-07 23:59:25','2015-07-07 23:59:25'),(17,0,'INV-2013-00',0,'corsicagallery.com','http://corsicagallery.com/',0,1,'Ключко Андрей','','woody@nixsolutions.com','45629356932657932','','a:0:{}','Ключко Андрей','','','','','Харьков','','',0,'',0,'','a:0:{}','Оплата при доставке','cod','Андрей','','','','','Харьков','','',0,'',0,'','a:0:{}','','','Попробуйте выполнить обратную задачу — запомнить схему (обстановку) комнаты, изображенной на картинке, используя для ее запоминания любой хорошо известный вам ряд слов. (Напомню, что в качестве такого ряда может выступить список ключевых слов хорошо известной вам песни, басни, стихотворения). В обстановке комнаты попытайтесь запомнить не только входящие в нее элементы, но и что где расположено. Для этого «обходите» комнату последовательно.\n','76868.0000',2,0,'0.0000',0,'',2,2,'USD','1.00000000','37.57.25.26','','Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.132 Safari/537.36','en-US,en;q=0.8,de;q=0.6,pl;q=0.4,ru;q=0.2,sv;q=0.2,uk;q=0.2,tr;q=0.2','2015-07-16 01:01:01','2015-07-16 01:01:02');

/*Table structure for table `cs_order_custom_field` */

DROP TABLE IF EXISTS `cs_order_custom_field`;

CREATE TABLE `cs_order_custom_field` (
...
/*Data for the table `cs_order_custom_field` */

/*Table structure for table `cs_order_fraud` */

DROP TABLE IF EXISTS `cs_order_fraud`;

CREATE TABLE `cs_order_fraud` (
  `order_id` int(11) NOT NULL,
  `customer_id` int(11) NOT NULL,
...
/*Data for the table `cs_order_fraud` */
...
/*Data for the table `cs_order_history` */

insert  into `cs_order_history`(`order_history_id`,`order_id`,`order_status_id`,`notify`,`comment`,`date_added`) values (15,17,2,0,'','2015-07-16 01:01:02'),(14,16,7,1,'Инструкции по банковскому переводу\n\nНомер картьі приватбанка\n\nЗаказ не будет обработан, пока деньги не поступят на наш расчетный счёт.','2015-07-16 00:34:04'),(13,15,2,0,'','2015-07-16 00:23:34');

/*Table structure for table `cs_order_option` */

DROP TABLE IF EXISTS `cs_order_option`;

CREATE TABLE `cs_order_option` (
...
/*Data for the table `cs_order_option` */

insert  into `cs_order_option`(`order_option_id`,`order_id`,`order_product_id`,`product_option_id`,`product_option_value_id`,`name`,`value`,`type`) values (29,9,15,255,135,'Цвет','Черньій','radio'),(3,2,2,257,144,'Цвет','Черньій','radio'),(4,2,2,256,139,'Размер','44','select'),(5,2,3,255,135,'Цвет','Черньій','radio'),(6,2,3,254,130,'Размер','44','select'),(7,2,4,235,51,'Цвет','Черньій','radio'),(8,2,4,234,46,'Размер','44','select'),(9,3,5,257,144,'Цвет','Черньій','radio'),(10,3,5,256,139,'Размер','44','select'),(11,3,6,255,135,'Цвет','Черньій','radio'),(12,3,6,254,130,'Размер','44','select'),(13,3,7,235,51,'Цвет','Черньій','radio'),(14,3,7,234,46,'Размер','44','select'),(35,12,18,230,33,'Цвет','Черньій','radio'),(41,15,22,242,82,'Размер','52','select'),(40,15,22,243,85,'Цвет','Черньій','radio'),(32,10,16,254,134,'Размер','46','select'),(31,10,16,255,135,'Цвет','Черньій','radio'),(30,9,15,254,134,'Размер','46','select'),(21,5,11,235,51,'Цвет','Черньій','radio'),(22,5,11,234,46,'Размер','44','select'),(23,6,12,235,51,'Цвет','Черньій','radio'),(24,6,12,234,46,'Размер','44','select'),(44,17,24,257,145,'Цвет','Красньій','radio'),(43,16,23,234,48,'Размер','52','select'),(42,16,23,235,51,'Цвет','Черньій','radio'),(39,14,21,230,33,'Цвет','Черньій','radio'),(45,17,24,256,143,'Размер','46','select');

/*Table structure for table `cs_order_product` */

DROP TABLE IF EXISTS `cs_order_product`;

CREATE TABLE `cs_order_product` (
...
/*Data for the table `cs_order_product` */

insert  into `cs_order_product`(`order_product_id`,`order_id`,`product_id`,`name`,`model`,`quantity`,`price`,`total`,`tax`,`reward`) values (15,9,63,'Шаблон товара магазина','Sandra',1,'56756.0000','56756.0000','0.0000',0),(2,2,64,'Шаблон товара магазина','Sandra',1,'76868.0000','76868.0000','0.0000',0),(3,2,63,'Шаблон товара магазина','Sandra',1,'56756.0000','56756.0000','0.0000',0),(4,2,53,'Шаблон товара магазина','Sandra',1,'145.0000','145.0000','0.0000',0),(5,3,64,'Шаблон товара магазина','Sandra',1,'76868.0000','76868.0000','0.0000',0),(6,3,63,'Шаблон товара магазина','Sandra',1,'56756.0000','56756.0000','0.0000',0),(7,3,53,'Шаблон товара магазина','Sandra',1,'145.0000','145.0000','0.0000',0),(18,12,50,'Шаблон ростовки коллекции','Sandra',1,'492.0000','492.0000','0.0000',0),(22,15,57,'Шаблон товара магазина','Sandra',1,'678.0000','678.0000','0.0000',0),(16,10,63,'Шаблон товара магазина','Sandra',1,'56756.0000','56756.0000','0.0000',0),(11,5,53,'Шаблон товара магазина','Sandra',1,'145.0000','145.0000','0.0000',0),(12,6,53,'Шаблон товара магазина','Sandra',1,'145.0000','145.0000','0.0000',0),(24,17,64,'Шаблон товара магазина','Sandra',1,'76868.0000','76868.0000','0.0000',0),(23,16,53,'Шаблон товара магазина','Sandra',1,'145.0000','145.0000','0.0000',0),(21,14,50,'Шаблон ростовки коллекции','Sandra',1,'492.0000','492.0000','0.0000',0);

/*Table structure for table `cs_order_recurring` */

DROP TABLE IF EXISTS `cs_order_recurring`;

CREATE TABLE `cs_order_recurring` (
...
/*Data for the table `cs_order_recurring` */

/*Table structure for table `cs_order_recurring_transaction` */

DROP TABLE IF EXISTS `cs_order_recurring_transaction`;

CREATE TABLE `cs_order_recurring_transaction` (
...
/*Data for the table `cs_order_recurring_transaction` */

/*Table structure for table `cs_order_status` */

DROP TABLE IF EXISTS `cs_order_status`;
...
/*Data for the table `cs_order_status` */

insert  into `cs_order_status`(`order_status_id`,`language_id`,`name`) values (2,3,'У обробці'),(7,3,'Отменен'),(5,3,'Завершений'),(9,3,'Відмінений зворотньо'),(10,3,'Невдалий'),(11,3,'Возвращен'),(12,3,'Повернений'),(1,3,'Очікує'),(15,3,'Оброблений'),(2,2,'В обработке'),(3,2,'Доставлен'),(7,2,'Отменен'),(5,2,'Завершен'),(8,2,'Запрещен'),(9,2,'Отменен обратно'),(11,2,'Возвращен'),(12,2,'Возвращен'),(13,2,'Возвратный платеж'),(1,2,'Ожидает'),(16,1,'Voided'),(15,2,'Обработан'),(14,2,'Просрочен'),(7,1,'Canceled'),(10,2,'Неудачен'),(16,3,'Анульований'),(16,2,'Анулирован'),(10,1,'Failed'),(3,3,'Доставлений'),(3,1,'Shipped'),(12,1,'Reversed'),(11,1,'Refunded'),(2,1,'Processing'),(15,1,'Processed'),(1,1,'Pending'),(14,3,'Просрочений'),(14,1,'Expired'),(8,3,'Відмовлений'),(8,1,'Denied'),(5,1,'Complete'),(13,3,'Возвратный платеж'),(13,1,'Chargeback'),(9,1,'Canceled Reversal');

/*Table structure for table `cs_order_total` */

DROP TABLE IF EXISTS `cs_order_total`;

CREATE TABLE `cs_order_total` (
...
/*Data for the table `cs_order_total` */

insert  into `cs_order_total`(`order_total_id`,`order_id`,`code`,`title`,`value`,`sort_order`) values (19,9,'total','Итого','56756.0000',9),(20,10,'sub_total','Сумма','56756.0000',1),(18,9,'sub_total','Сумма','56756.0000',1),(4,2,'sub_total','Сумма','133769.0000',1),(5,2,'total','Итого','133769.0000',9),(6,3,'sub_total','Сумма','133769.0000',1),(7,3,'total','Итого','133769.0000',9),(21,10,'total','Итого','56756.0000',9),(10,5,'sub_total','Сумма','145.0000',1),(11,5,'total','Итого','145.0000',9),(12,6,'sub_total','Сумма','145.0000',1),(13,6,'total','Итого','145.0000',9),(24,12,'sub_total','Сумма','492.0000',1),(30,15,'sub_total','Сумма','678.0000',1),(25,12,'total','Итого','492.0000',9),(32,16,'sub_total','Сумма','145.0000',1),(31,15,'total','Итого','678.0000',9),(28,14,'sub_total','Сумма','492.0000',1),(29,14,'total','Итого','492.0000',9),(33,16,'total','Итого','145.0000',9),(34,17,'sub_total','Сумма','76868.0000',1),(35,17,'total','Итого','76868.0000',9);

/*Table structure for table `cs_order_voucher` */

DROP TABLE IF EXISTS `cs_order_voucher`;

CREATE TABLE `cs_order_voucher` (
...
/*Data for the table `cs_order_voucher` */
...
insert  into `cs_product`(`product_id`,`model`,`sku`,`upc`,`ean`,`jan`,`isbn`,`mpn`,`location`,`quantity`,`stock_status_id`,`image`,`manufacturer_id`,`shipping`,`price`,`points`,`tax_class_id`,`date_available`,`weight`,`weight_class_id`,`length`,`width`,`height`,`length_class_id`,`subtract`,`minimum`,`sort_order`,`status`,`viewed`,`date_added`,`date_modified`) values (50,'Sandra','M102007','','','','','','',1,6,'catalog/sping-2015/kate-moss-mango.jpg',0,0,'123.0000',0,0,'2015-04-16','0.00000000',1,'0.00000000','0.00000000','0.00000000',2,1,1,1,1,314,'2015-04-16 13:57:30','2015-07-05 22:17:41'),(51,'Sandra','','','','','','','',1,6,'catalog/sping-2015/tumblr_inline_nf2faa7Zfz1rx7s1u.jpg',0,1,'145.0000',0,0,'2015-04-16','0.00000000',1,'0.00000000','0.00000000','0.00000000',2,1,1,1,1,246,'2015-06-29 16:20:50','2015-07-03 23:36:54'),(53,'Sandra','','','','','','','',1,6,'catalog/sping-2015/39cbb70e7ad70833ec426940ca6d4523.jpg',0,1,'145.0000',0,0,'2015-04-16','0.00000000',1,'0.00000000','0.00000000','0.00000000',2,1,1,1,1,12,'2015-07-03 23:14:03','2015-07-03 23:34:17'),(56,'Sandra','','','','','','','',1,6,'catalog/sping-2015/48b58599e6cd55c3bb115158b3ae2e2b.jpg',0,1,'567.0000',0,0,'2015-04-16','0.00000000',1,'0.00000000','0.00000000','0.00000000',2,1,1,1,1,2,'2015-07-03 23:14:13','2015-07-03 23:34:30'),(57,'Sandra','','','','','','','',0,6,'catalog/sping-2015/black-pvc-matrix-look-coat-fancy-dress-costume-uk8-ar2022.jpg',0,1,'678.0000',0,0,'2015-04-16','0.00000000',1,'0.00000000','0.00000000','0.00000000',2,1,1,1,1,1,'2015-07-03 23:14:13','2015-07-03 23:34:40'),(62,'Sandra','','','','','','','',1,6,'catalog/sping-2015/download (1).jpg',0,1,'5674.0000',0,0,'2015-04-16','0.00000000',1,'0.00000000','0.00000000','0.00000000',2,1,1,1,1,4,'2015-07-03 23:16:00','2015-07-03 23:34:55'),(63,'Sandra','','','','','','','',1,6,'catalog/sping-2015/images (3).jpg',0,1,'56756.0000',0,0,'2015-04-16','0.00000000',1,'0.00000000','0.00000000','0.00000000',2,1,1,1,1,32,'2015-07-03 23:16:00','2015-07-10 00:02:26'),(64,'Sandra','','','','','','','',0,6,'catalog/sping-2015/images (4).jpg',0,1,'76868.0000',0,0,'2015-04-16','0.00000000',1,'0.00000000','0.00000000','0.00000000',2,1,1,1,1,10,'2015-07-03 23:16:00','2015-07-03 23:35:39'),(65,'Sandra','','','','','','','',1,6,'catalog/sping-2015/kate-moss-mango.jpg',0,1,'78979.0000',0,0,'2015-04-16','0.00000000',1,'0.00000000','0.00000000','0.00000000',2,1,1,1,1,0,'2015-07-03 23:16:00','2015-07-03 23:35:51');

/*Table structure for table `cs_product_attribute` */

DROP TABLE IF EXISTS `cs_product_attribute`;

CREATE TABLE `cs_product_attribute` (
  `product_id` int(11) NOT NULL,
  `attribute_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `text` text NOT NULL,
...
DROP TABLE IF EXISTS `cs_product_description`;

CREATE TABLE `cs_product_description` (
  `product_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
  `description` text NOT NULL,
...
insert  into `cs_product_description`(`product_id`,`language_id`,`name`,`description`,`tag`,`meta_title`,`meta_description`,`meta_keyword`) values (50,3,'Шаблон ростовки коллекции','&lt;p&gt;Lorem ipsum dollores...&lt;/p&gt;','','Test','',''),(51,1,'Шаблон товара магазина','&lt;p&gt;Lorem ipsum dollores...&lt;br&gt;&lt;/p&gt;','','Test','',''),(50,2,'Шаблон ростовки коллекции','&lt;p&gt;Lorem ipsum dollores...&lt;/p&gt;','','Тест','',''),(51,2,'Шаблон товара магазина','&lt;p&gt;Lorem ipsum dollores...&lt;/p&gt;','','Тест','',''),(51,3,'Шаблон товара магазина','&lt;p&gt;Lorem ipsum dollores...&lt;/p&gt;','','Тест','',''),(50,1,'Шаблон ростовки коллекции','&lt;p&gt;Lorem ipsum dollores...&lt;br&gt;&lt;/p&gt;','','Test','',''),(53,1,'Шаблон товара магазина','&lt;p&gt;Lorem ipsum dollores...&lt;br&gt;&lt;/p&gt;','','Test','',''),(53,3,'Шаблон товара магазина','&lt;p&gt;Lorem ipsum dollores...&lt;/p&gt;','','Тест','',''),(53,2,'Шаблон товара магазина','&lt;p&gt;Lorem ipsum dollores...&lt;/p&gt;','','Тест','',''),(56,1,'Шаблон товара магазина','&lt;p&gt;Lorem ipsum dollores...&lt;br&gt;&lt;/p&gt;','','Test','',''),(56,3,'Шаблон товара магазина','&lt;p&gt;Lorem ipsum dollores...&lt;/p&gt;','','Тест','',''),(56,2,'Шаблон товара магазина','&lt;p&gt;Lorem ipsum dollores...&lt;/p&gt;','','Тест','',''),(57,1,'Шаблон товара магазина','&lt;p&gt;Lorem ipsum dollores...&lt;br&gt;&lt;/p&gt;','','Test','',''),(57,3,'Шаблон товара магазина','&lt;p&gt;Lorem ipsum dollores...&lt;/p&gt;','','Тест','',''),(57,2,'Шаблон товара магазина','&lt;p&gt;Lorem ipsum dollores...&lt;/p&gt;','','Тест','',''),(62,1,'Шаблон товара магазина','&lt;p&gt;Lorem ipsum dollores...&lt;br&gt;&lt;/p&gt;','','Test','',''),(62,3,'Шаблон товара магазина','&lt;p&gt;Lorem ipsum dollores...&lt;/p&gt;','','Тест','',''),(62,2,'Шаблон товара магазина','&lt;p&gt;Lorem ipsum dollores...&lt;/p&gt;','','Тест','',''),(63,1,'Шаблон товара магазина','&lt;p&gt;Lorem ipsum dollores...&lt;br&gt;&lt;/p&gt;','','Test','',''),(63,2,'Шаблон товара магазина','&lt;p&gt;Lorem ipsum dollores...&lt;/p&gt;','','Тест','',''),(63,3,'Шаблон товара магазина','&lt;p&gt;Lorem ipsum dollores...&lt;/p&gt;','','Тест','',''),(64,1,'Шаблон товара магазина','&lt;p&gt;Lorem ipsum dollores...&lt;br&gt;&lt;/p&gt;','','Test','',''),(64,3,'Шаблон товара магазина','&lt;p&gt;Lorem ipsum dollores...&lt;/p&gt;','','Тест','',''),(64,2,'Шаблон товара магазина','&lt;p&gt;Lorem ipsum dollores...&lt;/p&gt;','','Тест','',''),(65,1,'Шаблон товара магазина','&lt;p&gt;Lorem ipsum dollores...&lt;br&gt;&lt;/p&gt;','','Test','',''),(65,2,'Шаблон товара магазина','&lt;p&gt;Lorem ipsum dollores...&lt;/p&gt;','','Тест','',''),(65,3,'Шаблон товара магазина','&lt;p&gt;Lorem ipsum dollores...&lt;/p&gt;','','Тест','','');

/*Table structure for table `cs_product_discount` */

DROP TABLE IF EXISTS `cs_product_discount`;

CREATE TABLE `cs_product_discount` (
...
/*Data for the table `cs_product_discount` */

/*Table structure for table `cs_product_filter` */

DROP TABLE IF EXISTS `cs_product_filter`;

CREATE TABLE `cs_product_filter` (
  `product_id` int(11) NOT NULL,
  `filter_id` int(11) NOT NULL,
  PRIMARY KEY (`product_id`,`filter_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

/*Data for the table `cs_product_filter` */

/*Table structure for table `cs_product_image` */

DROP TABLE IF EXISTS `cs_product_image`;

CREATE TABLE `cs_product_image` (
...
insert  into `cs_product_image`(`product_image_id`,`product_id`,`image`,`sort_order`) values (2468,50,'catalog/bg-about.jpg',0),(2469,50,'catalog/sping-2015/bg-collection.jpg',0),(2466,51,'catalog/sping-2015/bg-collection.jpg',0),(2467,51,'catalog/bg-about.jpg',0),(2451,53,'catalog/sping-2015/bg-collection.jpg',0),(2450,53,'catalog/bg-about.jpg',0),(2453,56,'catalog/sping-2015/bg-collection.jpg',0),(2452,56,'catalog/bg-about.jpg',0),(2455,57,'catalog/sping-2015/bg-collection.jpg',0),(2454,57,'catalog/bg-about.jpg',0),(2471,63,'catalog/bg-about.jpg',0),(2457,62,'catalog/sping-2015/bg-collection.jpg',0),(2456,62,'catalog/bg-about.jpg',0),(2470,63,'catalog/sping-2015/bg-collection.jpg',0),(2461,64,'catalog/sping-2015/bg-collection.jpg',0),(2460,64,'catalog/bg-about.jpg',0),(2462,65,'catalog/bg-about.jpg',0),(2463,65,'catalog/sping-2015/bg-collection.jpg',0);

/*Table structure for table `cs_product_option` */

DROP TABLE IF EXISTS `cs_product_option`;

CREATE TABLE `cs_product_option` (
...
insert  into `cs_product_option`(`product_option_id`,`product_id`,`option_id`,`value`,`required`) values (229,51,11,'',1),(228,51,1,'',1),(231,50,11,'',1),(230,50,1,'',1),(235,53,1,'',1),(234,53,11,'',1),(241,56,1,'',1),(240,56,11,'',1),(243,57,1,'',1),(242,57,11,'',1),(253,62,1,'',1),(252,62,11,'',1),(254,63,11,'',1),(255,63,1,'',1),(257,64,1,'',1),(256,64,11,'',1),(259,65,1,'',1),(258,65,11,'',1);

/*Table structure for table `cs_product_option_value` */

DROP TABLE IF EXISTS `cs_product_option_value`;

CREATE TABLE `cs_product_option_value` (
...
insert  into `cs_product_option_value`(`product_option_value_id`,`product_option_id`,`product_id`,`option_id`,`option_value_id`,`quantity`,`subtract`,`price`,`price_prefix`,`points`,`points_prefix`,`weight`,`weight_prefix`) values (27,229,51,11,48,100,1,'0.0000','+',0,'+','0.00000000','+'),(29,229,51,11,53,100,1,'0.0000','+',0,'+','0.00000000','+'),(26,229,51,11,47,100,1,'0.0000','+',0,'+','0.00000000','+'),(25,229,51,11,46,100,1,'0.0000','+',0,'+','0.00000000','+'),(28,229,51,11,50,100,1,'0.0000','+',0,'+','0.00000000','+'),(24,228,51,1,32,100,1,'0.0000','+',0,'+','0.00000000','+'),(23,228,51,1,31,100,1,'0.0000','+',0,'+','0.00000000','+'),(22,228,51,1,49,100,1,'0.0000','+',0,'+','0.00000000','+'),(21,228,51,1,43,100,1,'0.0000','+',0,'+','0.00000000','+'),(35,231,50,11,48,100,1,'0.0000','+',0,'+','0.00000000','+'),(34,231,50,11,46,100,1,'0.0000','+',0,'+','0.00000000','+'),(36,231,50,11,51,100,1,'0.0000','+',0,'+','0.00000000','+'),(37,231,50,11,53,100,1,'0.0000','+',0,'+','0.00000000','+'),(30,230,50,1,49,100,1,'0.0000','+',0,'+','0.00000000','+'),(31,230,50,1,43,100,1,'0.0000','+',0,'+','0.00000000','+'),(32,230,50,1,31,100,1,'0.0000','+',0,'+','0.00000000','+'),(33,230,50,1,32,100,1,'0.0000','+',0,'+','0.00000000','+'),(54,235,53,1,49,100,1,'0.0000','+',0,'+','0.00000000','+'),(53,235,53,1,43,100,1,'0.0000','+',0,'+','0.00000000','+'),(52,235,53,1,31,100,1,'0.0000','+',0,'+','0.00000000','+'),(51,235,53,1,32,100,1,'0.0000','+',0,'+','0.00000000','+'),(50,234,53,11,50,100,1,'0.0000','+',0,'+','0.00000000','+'),(49,234,53,11,46,100,1,'0.0000','+',0,'+','0.00000000','+'),(48,234,53,11,53,100,1,'0.0000','+',0,'+','0.00000000','+'),(47,234,53,11,47,100,1,'0.0000','+',0,'+','0.00000000','+'),(46,234,53,11,48,100,1,'0.0000','+',0,'+','0.00000000','+'),(79,241,56,1,49,100,1,'0.0000','+',0,'+','0.00000000','+'),(78,241,56,1,43,100,1,'0.0000','+',0,'+','0.00000000','+'),(77,241,56,1,31,100,1,'0.0000','+',0,'+','0.00000000','+'),(76,241,56,1,32,100,1,'0.0000','+',0,'+','0.00000000','+'),(75,240,56,11,50,100,1,'0.0000','+',0,'+','0.00000000','+'),(74,240,56,11,46,100,1,'0.0000','+',0,'+','0.00000000','+'),(73,240,56,11,53,100,1,'0.0000','+',0,'+','0.00000000','+'),(72,240,56,11,47,100,1,'0.0000','+',0,'+','0.00000000','+'),(71,240,56,11,48,100,1,'0.0000','+',0,'+','0.00000000','+'),(88,243,57,1,49,100,1,'0.0000','+',0,'+','0.00000000','+'),(87,243,57,1,43,100,1,'0.0000','+',0,'+','0.00000000','+'),(86,243,57,1,31,100,1,'0.0000','+',0,'+','0.00000000','+'),(85,243,57,1,32,99,1,'0.0000','+',0,'+','0.00000000','+'),(84,242,57,11,50,100,1,'0.0000','+',0,'+','0.00000000','+'),(83,242,57,11,46,100,1,'0.0000','+',0,'+','0.00000000','+'),(82,242,57,11,53,99,1,'0.0000','+',0,'+','0.00000000','+'),(81,242,57,11,47,100,1,'0.0000','+',0,'+','0.00000000','+'),(80,242,57,11,48,100,1,'0.0000','+',0,'+','0.00000000','+'),(129,253,62,1,49,100,1,'0.0000','+',0,'+','0.00000000','+'),(128,253,62,1,43,100,1,'0.0000','+',0,'+','0.00000000','+'),(127,253,62,1,31,100,1,'0.0000','+',0,'+','0.00000000','+'),(126,253,62,1,32,100,1,'0.0000','+',0,'+','0.00000000','+'),(125,252,62,11,50,100,1,'0.0000','+',0,'+','0.00000000','+'),(124,252,62,11,46,100,1,'0.0000','+',0,'+','0.00000000','+'),(123,252,62,11,53,100,1,'0.0000','+',0,'+','0.00000000','+'),(122,252,62,11,47,100,1,'0.0000','+',0,'+','0.00000000','+'),(121,252,62,11,48,100,1,'0.0000','+',0,'+','0.00000000','+'),(130,254,63,11,48,100,1,'0.0000','+',0,'+','0.00000000','+'),(131,254,63,11,47,100,1,'0.0000','+',0,'+','0.00000000','+'),(132,254,63,11,53,100,1,'0.0000','+',0,'+','0.00000000','+'),(133,254,63,11,46,100,1,'0.0000','+',0,'+','0.00000000','+'),(134,254,63,11,50,100,1,'0.0000','+',0,'+','0.00000000','+'),(135,255,63,1,32,100,1,'0.0000','+',0,'+','0.00000000','+'),(136,255,63,1,31,100,1,'0.0000','+',0,'+','0.00000000','+'),(137,255,63,1,43,100,1,'0.0000','+',0,'+','0.00000000','+'),(138,255,63,1,49,100,1,'0.0000','+',0,'+','0.00000000','+'),(147,257,64,1,49,100,1,'0.0000','+',0,'+','0.00000000','+'),(146,257,64,1,43,100,1,'0.0000','+',0,'+','0.00000000','+'),(145,257,64,1,31,99,1,'0.0000','+',0,'+','0.00000000','+'),(144,257,64,1,32,100,1,'0.0000','+',0,'+','0.00000000','+'),(143,256,64,11,50,99,1,'0.0000','+',0,'+','0.00000000','+'),(142,256,64,11,46,100,1,'0.0000','+',0,'+','0.00000000','+'),(141,256,64,11,53,100,1,'0.0000','+',0,'+','0.00000000','+'),(140,256,64,11,47,100,1,'0.0000','+',0,'+','0.00000000','+'),(139,256,64,11,48,100,1,'0.0000','+',0,'+','0.00000000','+'),(156,259,65,1,49,100,1,'0.0000','+',0,'+','0.00000000','+'),(155,259,65,1,43,100,1,'0.0000','+',0,'+','0.00000000','+'),(154,259,65,1,31,100,1,'0.0000','+',0,'+','0.00000000','+'),(153,259,65,1,32,100,1,'0.0000','+',0,'+','0.00000000','+'),(152,258,65,11,50,100,1,'0.0000','+',0,'+','0.00000000','+'),(151,258,65,11,46,100,1,'0.0000','+',0,'+','0.00000000','+'),(150,258,65,11,53,100,1,'0.0000','+',0,'+','0.00000000','+'),(149,258,65,11,47,100,1,'0.0000','+',0,'+','0.00000000','+'),(148,258,65,11,48,100,1,'0.0000','+',0,'+','0.00000000','+');

/*Table structure for table `cs_product_recurring` */

DROP TABLE IF EXISTS `cs_product_recurring`;

CREATE TABLE `cs_product_recurring` (
  `product_id` int(11) NOT NULL,
  `recurring_id` int(11) NOT NULL,
  `customer_group_id` int(11) NOT NULL,
...
/*Data for the table `cs_product_recurring` */

/*Table structure for table `cs_product_related` */

DROP TABLE IF EXISTS `cs_product_related`;

CREATE TABLE `cs_product_related` (
  `product_id` int(11) NOT NULL,
  `related_id` int(11) NOT NULL,
  PRIMARY KEY (`product_id`,`related_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

/*Data for the table `cs_product_related` */

/*Table structure for table `cs_product_reward` */

DROP TABLE IF EXISTS `cs_product_reward`;

CREATE TABLE `cs_product_reward` (
...
/*Data for the table `cs_product_reward` */

/*Table structure for table `cs_product_special` */

DROP TABLE IF EXISTS `cs_product_special`;

CREATE TABLE `cs_product_special` (
...
/*Data for the table `cs_product_special` */

/*Table structure for table `cs_product_to_category` */

DROP TABLE IF EXISTS `cs_product_to_category`;

CREATE TABLE `cs_product_to_category` (
  `product_id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL,
...
/*Data for the table `cs_product_to_category` */

insert  into `cs_product_to_category`(`product_id`,`category_id`) values (50,59),(51,60),(53,60),(56,60),(57,60),(62,60),(63,63),(64,60),(65,60);

/*Table structure for table `cs_product_to_download` */

DROP TABLE IF EXISTS `cs_product_to_download`;

CREATE TABLE `cs_product_to_download` (
  `product_id` int(11) NOT NULL,
  `download_id` int(11) NOT NULL,
  PRIMARY KEY (`product_id`,`download_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

/*Data for the table `cs_product_to_download` */

/*Table structure for table `cs_product_to_layout` */

DROP TABLE IF EXISTS `cs_product_to_layout`;

CREATE TABLE `cs_product_to_layout` (
  `product_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL,
...
insert  into `cs_product_to_layout`(`product_id`,`store_id`,`layout_id`) values (51,0,0),(50,0,0),(53,0,0),(56,0,0),(57,0,0),(62,0,0),(63,0,0),(64,0,0),(65,0,0);

/*Table structure for table `cs_product_to_store` */

DROP TABLE IF EXISTS `cs_product_to_store`;

CREATE TABLE `cs_product_to_store` (
  `product_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`product_id`,`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

/*Data for the table `cs_product_to_store` */

insert  into `cs_product_to_store`(`product_id`,`store_id`) values (50,0),(51,0),(53,0),(56,0),(57,0),(62,0),(63,0),(64,0),(65,0);

/*Table structure for table `cs_recurring` */

DROP TABLE IF EXISTS `cs_recurring`;

CREATE TABLE `cs_recurring` (
...
/*Data for the table `cs_recurring` */

/*Table structure for table `cs_recurring_description` */

DROP TABLE IF EXISTS `cs_recurring_description`;

CREATE TABLE `cs_recurring_description` (
  `recurring_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
...
/*Data for the table `cs_recurring_description` */

/*Table structure for table `cs_return` */

DROP TABLE IF EXISTS `cs_return`;

CREATE TABLE `cs_return` (
...
/*Data for the table `cs_return` */

/*Table structure for table `cs_return_action` */

DROP TABLE IF EXISTS `cs_return_action`;

CREATE TABLE `cs_return_action` (
...
/*Data for the table `cs_return_action` */

insert  into `cs_return_action`(`return_action_id`,`language_id`,`name`) values (1,1,'Refunded'),(2,1,'Credit Issued'),(3,1,'Replacement Sent'),(1,2,'Refunded'),(2,2,'Credit Issued'),(3,2,'Replacement Sent'),(1,3,'Refunded'),(2,3,'Credit Issued'),(3,3,'Replacement Sent');

/*Table structure for table `cs_return_history` */

DROP TABLE IF EXISTS `cs_return_history`;

CREATE TABLE `cs_return_history` (
...
/*Data for the table `cs_return_history` */

/*Table structure for table `cs_return_reason` */

DROP TABLE IF EXISTS `cs_return_reason`;

CREATE TABLE `cs_return_reason` (
...
/*Data for the table `cs_return_status` */

insert  into `cs_return_status`(`return_status_id`,`language_id`,`name`) values (1,1,'Pending'),(3,1,'Complete'),(2,1,'Awaiting Products'),(1,2,'Pending'),(3,2,'Complete'),(2,2,'Awaiting Products'),(1,3,'Pending'),(3,3,'Complete'),(2,3,'Awaiting Products');
...
/*Data for the table `cs_review` */

/*Table structure for table `cs_setting` */
...
) ENGINE=MyISAM AUTO_INCREMENT=6868 DEFAULT CHARSET=utf8;

/*Data for the table `cs_setting` */

insert  into `cs_setting`(`setting_id`,`store_id`,`code`,`key`,`value`,`serialized`) values (4315,0,'shipping','shipping_sort_order','3',0),(2,0,'sub_total','sub_total_sort_order','1',0),(3,0,'sub_total','sub_total_status','1',0),(4,0,'tax','tax_status','1',0),(5,0,'total','total_sort_order','9',0),(6,0,'total','total_status','1',0),(7,0,'tax','tax_sort_order','5',0),(6864,0,'bank_transfer','bank_transfer_order_status_id','2',0),(6863,0,'bank_transfer','bank_transfer_total','',0),(4314,0,'shipping','shipping_status','0',0),(4313,0,'shipping','shipping_estimator','0',0),(4303,0,'coupon','coupon_sort_order','4',0),(4302,0,'coupon','coupon_status','0',0),(4329,0,'cod','cod_geo_zone_id','0',0),(4328,0,'cod','cod_order_status_id','2',0),(4327,0,'cod','cod_total','',0),(4305,0,'credit','credit_sort_order','7',0),(4304,0,'credit','credit_status','0',0),(4307,0,'reward','reward_sort_order','2',0),(4306,0,'reward','reward_status','0',0),(159,0,'affiliate','affiliate_status','1',0),(4331,0,'cod','cod_sort_order','',0),(4330,0,'cod','cod_status','1',0),(6859,0,'config','config_google_captcha_status','0',0),(6858,0,'config','config_google_captcha_secret','',0),(6857,0,'config','config_google_captcha_public','',0),(6856,0,'config','config_google_analytics_status','0',0),(6855,0,'config','config_google_analytics','',0),(6854,0,'config','config_error_filename','error.log',0),(6853,0,'config','config_error_log','1',0),(6852,0,'config','config_error_display','1',0),(6844,0,'config','config_seo_url','1',0),(6845,0,'config','config_file_max_size','300000',0),(6846,0,'config','config_file_ext_allowed','zip\r\ntxt\r\npng\r\njpe\r\njpeg\r\njpg\r\ngif\r\nbmp\r\nico\r\ntiff\r\ntif\r\nsvg\r\nsvgz\r\nzip\r\nrar\r\nmsi\r\ncab\r\nmp3\r\nqt\r\nmov\r\npdf\r\npsd\r\nai\r\neps\r\nps\r\ndoc',0),(6847,0,'config','config_file_mime_allowed','text/plain\r\nimage/png\r\nimage/jpeg\r\nimage/gif\r\nimage/bmp\r\nimage/tiff\r\nimage/svg+xml\r\napplication/zip\r\n&quot;application/zip&quot;\r\napplication/x-zip\r\n&quot;application/x-zip&quot;\r\napplication/x-zip-compressed\r\n&quot;application/x-zip-compressed&quot;\r\napplication/rar\r\n&quot;application/rar&quot;\r\napplication/x-rar\r\n&quot;application/x-rar&quot;\r\napplication/x-rar-compressed\r\n&quot;application/x-rar-compressed&quot;\r\napplication/octet-stream\r\n&quot;application/octet-stream&quot;\r\naudio/mpeg\r\nvideo/quicktime\r\napplication/pdf',0),(6850,0,'config','config_encryption','39aeca12d0e94b63c80d699d3efafba5',0),(6851,0,'config','config_compression','0',0),(4312,0,'voucher','voucher_sort_order','8',0),(4311,0,'voucher','voucher_status','0',0),(6862,0,'bank_transfer','bank_transfer_bank1','Номер картьі приватбанка 1234 5678 9012 3456',0),(6848,0,'config','config_maintenance','1',0),(6849,0,'config','config_password','1',0),(6839,0,'config','config_fraud_score','',0),(6840,0,'config','config_fraud_status_id','7',0),(6841,0,'config','config_secure','0',0),(6842,0,'config','config_shared','0',0),(6843,0,'config','config_robots','abot\r\ndbot\r\nebot\r\nhbot\r\nkbot\r\nlbot\r\nmbot\r\nnbot\r\nobot\r\npbot\r\nrbot\r\nsbot\r\ntbot\r\nvbot\r\nybot\r\nzbot\r\nbot.\r\nbot/\r\n_bot\r\n.bot\r\n/bot\r\n-bot\r\n:bot\r\n(bot\r\ncrawl\r\nslurp\r\nspider\r\nseek\r\naccoona\r\nacoon\r\nadressendeutschland\r\nah-ha.com\r\nahoy\r\naltavista\r\nananzi\r\nanthill\r\nappie\r\narachnophilia\r\narale\r\naraneo\r\naranha\r\narchitext\r\naretha\r\narks\r\nasterias\r\natlocal\r\natn\r\natomz\r\naugurfind\r\nbackrub\r\nbannana_bot\r\nbaypup\r\nbdfetch\r\nbig brother\r\nbiglotron\r\nbjaaland\r\nblackwidow\r\nblaiz\r\nblog\r\nblo.\r\nbloodhound\r\nboitho\r\nbooch\r\nbradley\r\nbutterfly\r\ncalif\r\ncassandra\r\nccubee\r\ncfetch\r\ncharlotte\r\nchurl\r\ncienciaficcion\r\ncmc\r\ncollective\r\ncomagent\r\ncombine\r\ncomputingsite\r\ncsci\r\ncurl\r\ncusco\r\ndaumoa\r\ndeepindex\r\ndelorie\r\ndepspid\r\ndeweb\r\ndie blinde kuh\r\ndigger\r\nditto\r\ndmoz\r\ndocomo\r\ndownload express\r\ndtaagent\r\ndwcp\r\nebiness\r\nebingbong\r\ne-collector\r\nejupiter\r\nemacs-w3 search engine\r\nesther\r\nevliya celebi\r\nezresult\r\nfalcon\r\nfelix ide\r\nferret\r\nfetchrover\r\nfido\r\nfindlinks\r\nfireball\r\nfish search\r\nfouineur\r\nfunnelweb\r\ngazz\r\ngcreep\r\ngenieknows\r\ngetterroboplus\r\ngeturl\r\nglx\r\ngoforit\r\ngolem\r\ngrabber\r\ngrapnel\r\ngralon\r\ngriffon\r\ngromit\r\ngrub\r\ngulliver\r\nhamahakki\r\nharvest\r\nhavindex\r\nhelix\r\nheritrix\r\nhku www octopus\r\nhomerweb\r\nhtdig\r\nhtml index\r\nhtml_analyzer\r\nhtmlgobble\r\nhubater\r\nhyper-decontextualizer\r\nia_archiver\r\nibm_planetwide\r\nichiro\r\niconsurf\r\niltrovatore\r\nimage.kapsi.net\r\nimagelock\r\nincywincy\r\nindexer\r\ninfobee\r\ninformant\r\ningrid\r\ninktomisearch.com\r\ninspector web\r\nintelliagent\r\ninternet shinchakubin\r\nip3000\r\niron33\r\nisraeli-search\r\nivia\r\njack\r\njakarta\r\njavabee\r\njetbot\r\njumpstation\r\nkatipo\r\nkdd-explorer\r\nkilroy\r\nknowledge\r\nkototoi\r\nkretrieve\r\nlabelgrabber\r\nlachesis\r\nlarbin\r\nlegs\r\nlibwww\r\nlinkalarm\r\nlink validator\r\nlinkscan\r\nlockon\r\nlwp\r\nlycos\r\nmagpie\r\nmantraagent\r\nmapoftheinternet\r\nmarvin/\r\nmattie\r\nmediafox\r\nmediapartners\r\nmercator\r\nmerzscope\r\nmicrosoft url control\r\nminirank\r\nmiva\r\nmj12\r\nmnogosearch\r\nmoget\r\nmonster\r\nmoose\r\nmotor\r\nmultitext\r\nmuncher\r\nmuscatferret\r\nmwd.search\r\nmyweb\r\nnajdi\r\nnameprotect\r\nnationaldirectory\r\nnazilla\r\nncsa beta\r\nnec-meshexplorer\r\nnederland.zoek\r\nnetcarta webmap engine\r\nnetmechanic\r\nnetresearchserver\r\nnetscoop\r\nnewscan-online\r\nnhse\r\nnokia6682/\r\nnomad\r\nnoyona\r\nnutch\r\nnzexplorer\r\nobjectssearch\r\noccam\r\nomni\r\nopen text\r\nopenfind\r\nopenintelligencedata\r\norb search\r\nosis-project\r\npack rat\r\npageboy\r\npagebull\r\npage_verifier\r\npanscient\r\nparasite\r\npartnersite\r\npatric\r\npear.\r\npegasus\r\nperegrinator\r\npgp key agent\r\nphantom\r\nphpdig\r\npicosearch\r\npiltdownman\r\npimptrain\r\npinpoint\r\npioneer\r\npiranha\r\nplumtreewebaccessor\r\npogodak\r\npoirot\r\npompos\r\npoppelsdorf\r\npoppi\r\npopular iconoclast\r\npsycheclone\r\npublisher\r\npython\r\nrambler\r\nraven search\r\nroach\r\nroad runner\r\nroadhouse\r\nrobbie\r\nrobofox\r\nrobozilla\r\nrules\r\nsalty\r\nsbider\r\nscooter\r\nscoutjet\r\nscrubby\r\nsearch.\r\nsearchprocess\r\nsemanticdiscovery\r\nsenrigan\r\nsg-scout\r\nshai\'hulud\r\nshark\r\nshopwiki\r\nsidewinder\r\nsift\r\nsilk\r\nsimmany\r\nsite searcher\r\nsite valet\r\nsitetech-rover\r\nskymob.com\r\nsleek\r\nsmartwit\r\nsna-\r\nsnappy\r\nsnooper\r\nsohu\r\nspeedfind\r\nsphere\r\nsphider\r\nspinner\r\nspyder\r\nsteeler/\r\nsuke\r\nsuntek\r\nsupersnooper\r\nsurfnomore\r\nsven\r\nsygol\r\nszukacz\r\ntach black widow\r\ntarantula\r\ntempleton\r\n/teoma\r\nt-h-u-n-d-e-r-s-t-o-n-e\r\ntheophrastus\r\ntitan\r\ntitin\r\ntkwww\r\ntoutatis\r\nt-rex\r\ntutorgig\r\ntwiceler\r\ntwisted\r\nucsd\r\nudmsearch\r\nurl check\r\nupdated\r\nvagabondo\r\nvalkyrie\r\nverticrawl\r\nvictoria\r\nvision-search\r\nvolcano\r\nvoyager/\r\nvoyager-hc\r\nw3c_validator\r\nw3m2\r\nw3mir\r\nwalker\r\nwallpaper\r\nwanderer\r\nwauuu\r\nwavefire\r\nweb core\r\nweb hopper\r\nweb wombat\r\nwebbandit\r\nwebcatcher\r\nwebcopy\r\nwebfoot\r\nweblayers\r\nweblinker\r\nweblog monitor\r\nwebmirror\r\nwebmonkey\r\nwebquest\r\nwebreaper\r\nwebsitepulse\r\nwebsnarf\r\nwebstolperer\r\nwebvac\r\nwebwalk\r\nwebwatch\r\nwebwombat\r\nwebzinger\r\nwhizbang\r\nwhowhere\r\nwild ferret\r\nworldlight\r\nwwwc\r\nwwwster\r\nxenu\r\nxget\r\nxift\r\nxirq\r\nyandex\r\nyanga\r\nyeti\r\nyodao\r\nzao\r\nzippp\r\nzyborg',0),(6838,0,'config','config_fraud_key','',0),(6837,0,'config','config_fraud_detection','0',0),(6836,0,'config','config_mail_alert','andreyalek@gmail.com',0),(6835,0,'config','config_mail_smtp_timeout','5',0),(6834,0,'config','config_mail_smtp_port','587',0),(6833,0,'config','config_mail_smtp_password','wkwchdrdpisdfobr',0),(6832,0,'config','config_mail_smtp_username','andreyalek@gmail.com',0),(6830,0,'config','config_mail_parameter','',0),(6831,0,'config','config_mail_smtp_hostname','tls://smtp.gmail.com',0),(6829,0,'config','config_mail_protocol','smtp',0),(6828,0,'config','config_ftp_status','0',0),(6827,0,'config','config_ftp_root','',0),(6826,0,'config','config_ftp_password','',0),(6825,0,'config','config_ftp_username','',0),(6824,0,'config','config_ftp_port','21',0),(6823,0,'config','config_ftp_hostname','localhost',0),(6822,0,'config','config_image_location_height','50',0),(6821,0,'config','config_image_location_width','268',0),(6820,0,'config','config_image_cart_height','47',0),(6819,0,'config','config_image_cart_width','47',0),(6818,0,'config','config_image_wishlist_height','47',0),(6817,0,'config','config_image_wishlist_width','47',0),(6816,0,'config','config_image_compare_height','90',0),(6815,0,'config','config_image_compare_width','90',0),(6814,0,'config','config_image_related_height','80',0),(6813,0,'config','config_image_related_width','80',0),(6810,0,'config','config_image_product_height','750',0),(6811,0,'config','config_image_additional_width','74',0),(6812,0,'config','config_image_additional_height','74',0),(6809,0,'config','config_image_product_width','500',0),(6808,0,'config','config_image_popup_height','1334',0),(6807,0,'config','config_image_popup_width','2000',0),(6806,0,'config','config_image_thumb_height','750',0),(6805,0,'config','config_image_thumb_width','500',0),(6804,0,'config','config_image_category_height','1334',0),(6803,0,'config','config_image_category_width','2000',0),(6801,0,'config','config_logo','',0),(6802,0,'config','config_icon','catalog/icon-logo.png',0),(6800,0,'config','config_return_status_id','2',0),(6799,0,'config','config_return_id','0',0),(6798,0,'config','config_affiliate_mail','0',0),(6797,0,'config','config_affiliate_id','4',0),(6796,0,'config','config_affiliate_commission','5',0),(6795,0,'config','config_affiliate_auto','0',0),(6794,0,'config','config_affiliate_approval','0',0),(6793,0,'config','config_stock_checkout','0',0),(6792,0,'config','config_stock_warning','0',0),(6791,0,'config','config_stock_display','0',0),(6790,0,'config','config_order_mail','0',0),(6789,0,'config','config_complete_status','a:1:{i:0;s:1:\"5\";}',1),(6788,0,'config','config_processing_status','a:1:{i:0;s:1:\"2\";}',1),(6787,0,'config','config_order_status_id','1',0),(6786,0,'config','config_checkout_id','0',0),(6785,0,'config','config_checkout_guest','1',0),(6783,0,'config','config_api_id','1',0),(6861,0,'bank_transfer','bank_transfer_bank3','Номер картьі приватбанка',0),(6860,0,'bank_transfer','bank_transfer_bank2','Номер картьі приватбанка',0),(6784,0,'config','config_cart_weight','0',0),(6782,0,'config','config_invoice_prefix','INV-2013-00',0),(6781,0,'config','config_account_mail','1',0),(6780,0,'config','config_account_id','0',0),(6779,0,'config','config_login_attempts','5',0),(6778,0,'config','config_customer_price','0',0),(6777,0,'config','config_customer_group_display','a:1:{i:0;s:1:\"1\";}',1),(6776,0,'config','config_customer_group_id','1',0),(6775,0,'config','config_customer_online','0',0),(6774,0,'config','config_tax_customer','shipping',0),(6773,0,'config','config_tax_default','shipping',0),(6772,0,'config','config_tax','0',0),(6771,0,'config','config_voucher_max','1000',0),(6770,0,'config','config_voucher_min','1',0),(6769,0,'config','config_review_mail','0',0),(6768,0,'config','config_review_guest','0',0),(6767,0,'config','config_review_status','0',0),(6765,0,'config','config_product_description_length','100',0),(6766,0,'config','config_limit_admin','40',0),(6764,0,'config','config_product_limit','15',0),(6763,0,'config','config_product_count','1',0),(6762,0,'config','config_weight_class_id','1',0),(6761,0,'config','config_length_class_id','2',0),(6760,0,'config','config_currency_auto','1',0),(6759,0,'config','config_currency','USD',0),(6758,0,'config','config_admin_language','ru',0),(6757,0,'config','config_language','ru',0),(6756,0,'config','config_zone_id','4224',0),(6755,0,'config','config_country_id','220',0),(6754,0,'config','config_layout_id','4',0),(6753,0,'config','config_template','default',0),(6752,0,'config','config_meta_keyword','',0),(6750,0,'config','config_meta_title','Your Store',0),(6751,0,'config','config_meta_description','My Store',0),(6749,0,'config','config_comment','',0),(6748,0,'config','config_open','',0),(6747,0,'config','config_image','',0),(6746,0,'config','config_fax','',0),(6745,0,'config','config_telephone','123456789',0),(6744,0,'config','config_email','andreyalek@gmail.com',0),(6743,0,'config','config_geocode','',0),(6742,0,'config','config_address','Address 1',0),(6741,0,'config','config_owner','Your Name',0),(6740,0,'config','config_name','corsicagallery.com',0),(6865,0,'bank_transfer','bank_transfer_geo_zone_id','0',0),(6866,0,'bank_transfer','bank_transfer_status','1',0),(6867,0,'bank_transfer','bank_transfer_sort_order','',0);

/*Table structure for table `cs_stock_status` */

DROP TABLE IF EXISTS `cs_stock_status`;

CREATE TABLE `cs_stock_status` (
...
/*Data for the table `cs_stock_status` */

insert  into `cs_stock_status`(`stock_status_id`,`language_id`,`name`) values (7,3,'У наявності'),(8,3,'Попереднє замовлення'),(5,3,'Нема у наявності'),(6,1,'2-3 days'),(6,3,'2-3 дні'),(7,2,'В наличии'),(8,2,'Предзаказ'),(5,2,'Нет в наличии'),(6,2,'2-3 дня'),(7,1,'In Stock'),(8,1,'Pre-Order'),(5,1,'Out Of Stock');

/*Table structure for table `cs_store` */

DROP TABLE IF EXISTS `cs_store`;
...
DROP TABLE IF EXISTS `cs_tax_class`;

CREATE TABLE `cs_tax_class` (
...
/*Data for the table `cs_tax_class` */

insert  into `cs_tax_class`(`tax_class_id`,`title`,`description`,`date_added`,`date_modified`) values (9,'Taxable Goods','Taxed goods','2009-01-06 23:21:53','2011-09-23 14:07:50'),(10,'Downloadable Products','Downloadable','2011-09-21 22:19:39','2011-09-22 10:27:36');

/*Table structure for table `cs_tax_rate` */

DROP TABLE IF EXISTS `cs_tax_rate`;

CREATE TABLE `cs_tax_rate` (
...
/*Data for the table `cs_tax_rate` */

insert  into `cs_tax_rate`(`tax_rate_id`,`geo_zone_id`,`name`,`rate`,`type`,`date_added`,`date_modified`) values (86,3,'VAT (20%)','20.0000','P','2011-03-09 21:17:10','2011-09-22 22:24:29'),(87,3,'Eco Tax (-2.00)','2.0000','F','2011-09-21 21:49:23','2011-09-23 00:40:19');

/*Table structure for table `cs_tax_rate_to_customer_group` */

DROP TABLE IF EXISTS `cs_tax_rate_to_customer_group`;

CREATE TABLE `cs_tax_rate_to_customer_group` (
  `tax_rate_id` int(11) NOT NULL,
  `customer_group_id` int(11) NOT NULL,
  PRIMARY KEY (`tax_rate_id`,`customer_group_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

/*Data for the table `cs_tax_rate_to_customer_group` */

insert  into `cs_tax_rate_to_customer_group`(`tax_rate_id`,`customer_group_id`) values (86,1),(87,1);

/*Table structure for table `cs_tax_rule` */

DROP TABLE IF EXISTS `cs_tax_rule`;

CREATE TABLE `cs_tax_rule` (
...
/*Data for the table `cs_tax_rule` */

insert  into `cs_tax_rule`(`tax_rule_id`,`tax_class_id`,`tax_rate_id`,`based`,`priority`) values (121,10,86,'payment',1),(120,10,87,'store',0),(128,9,86,'shipping',1),(127,9,87,'shipping',2);

/*Table structure for table `cs_upload` */

DROP TABLE IF EXISTS `cs_upload`;
...
/*Data for the table `cs_upload` */

/*Table structure for table `cs_url_alias` */

DROP TABLE IF EXISTS `cs_url_alias`;

CREATE TABLE `cs_url_alias` (
...
insert  into `cs_url_alias`(`url_alias_id`,`query`,`keyword`) values (881,'product_id=50','collections/spring-2015/sandra'),(886,'category_id=63','collections/autumn-2014'),(853,'information_id=4','aboutus'),(852,'category_id=60','shop'),(888,'category_id=59','collections/spring-2015');
...
/*Data for the table `cs_user` */

insert  into `cs_user`(`user_id`,`user_group_id`,`username`,`password`,`salt`,`firstname`,`lastname`,`email`,`image`,`code`,`ip`,`status`,`date_added`) values (1,1,'admin','4eb09def0229d42d7d9ff950faa8122c30cc9e5b','f97d80576','John','Doe','admin@host.org','','','37.57.25.26',1,'2015-04-15 12:31:58');
...
/*Data for the table `cs_voucher` */

/*Table structure for table `cs_voucher_history` */

DROP TABLE IF EXISTS `cs_voucher_history`;

CREATE TABLE `cs_voucher_history` (
...
/*Data for the table `cs_voucher_history` */

/*Table structure for table `cs_voucher_theme` */

DROP TABLE IF EXISTS `cs_voucher_theme`;

CREATE TABLE `cs_voucher_theme` (
  `voucher_theme_id` int(11) NOT NULL AUTO_INCREMENT,
  `image` varchar(255) NOT NULL,
  PRIMARY KEY (`voucher_theme_id`)
) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=utf8;

/*Data for the table `cs_voucher_theme` */

insert  into `cs_voucher_theme`(`voucher_theme_id`,`image`) values (8,'catalog/demo/canon_eos_5d_2.jpg'),(7,'catalog/demo/gift-voucher-birthday.jpg'),(6,'catalog/demo/apple_logo.jpg');

/*Table structure for table `cs_voucher_theme_description` */

DROP TABLE IF EXISTS `cs_voucher_theme_description`;

CREATE TABLE `cs_voucher_theme_description` (
  `voucher_theme_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(32) NOT NULL,
...
/*Data for the table `cs_voucher_theme_description` */

insert  into `cs_voucher_theme_description`(`voucher_theme_id`,`language_id`,`name`) values (6,1,'Christmas'),(7,1,'Birthday'),(8,1,'General'),(6,2,'Christmas'),(7,2,'Birthday'),(8,2,'General'),(6,3,'Christmas'),(7,3,'Birthday'),(8,3,'General');

/*Table structure for table `cs_weight_class` */

DROP TABLE IF EXISTS `cs_weight_class`;

CREATE TABLE `cs_weight_class` (
  `weight_class_id` int(11) NOT NULL AUTO_INCREMENT,
  `value` decimal(15,8) NOT NULL DEFAULT '0.00000000',
  PRIMARY KEY (`weight_class_id`)
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;

/*Data for the table `cs_weight_class` */

insert  into `cs_weight_class`(`weight_class_id`,`value`) values (1,'1.00000000'),(2,'1000.00000000'),(5,'2.20460000'),(6,'35.27400000');

/*Table structure for table `cs_weight_class_description` */

DROP TABLE IF EXISTS `cs_weight_class_description`;

CREATE TABLE `cs_weight_class_description` (
  `weight_class_id` int(11) NOT NULL AUTO_INCREMENT,
  `language_id` int(11) NOT NULL,
  `title` varchar(32) NOT NULL,
  `unit` varchar(4) NOT NULL,
...
/*Data for the table `cs_weight_class_description` */

insert  into `cs_weight_class_description`(`weight_class_id`,`language_id`,`title`,`unit`) values (1,1,'Kilogram','kg'),(2,1,'Gram','g'),(5,1,'Pound ','lb'),(6,1,'Ounce','oz'),(1,2,'Kilogram','kg'),(2,2,'Gram','g'),(5,2,'Pound ','lb'),(6,2,'Ounce','oz'),(1,3,'Kilogram','kg'),(2,3,'Gram','g'),(5,3,'Pound ','lb'),(6,3,'Ounce','oz');

/*Table structure for table `cs_zone` */

DROP TABLE IF EXISTS `cs_zone`;

CREATE TABLE `cs_zone` (
