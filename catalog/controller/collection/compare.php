...
class ControllerProductCompare extends Controller {
		...
		foreach ($this->session->data['compare'] as $key => $product_id) {
			...
			if ($product_info) {
				...
				$data['products'][$product_id] = array(
					...
					'href'         => $this->url->link('collection/product', 'product_id=' . $product_id),
	...
	public function add() {
		...
		if ($product_info) {
			...
			$json['success'] = sprintf($this->language->get('text_success'), $this->url->link('collection/product', 'product_id=' . $this->request->post['product_id']), $product_info['name'], $this->url->link('product/compare'));
