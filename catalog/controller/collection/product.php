<?php
class ControllerCollectionProduct extends Controller {
	private $error = array();
	...
	public function index() {
        ...
        if (isset($this->request->get['path'])) {
            ...
            foreach ($parts as $path_id) {
                ...
                if ($category_info) {
                    $data['breadcrumbs'][] = array(
                        ...
                        'href' => $this->url->link('collection/category', 'path=' . $path)
                    );
                }
            }
            ...
            if ($category_info) {
                ...
                $data['breadcrumbs'][] = array(
                    'text' => $category_info['name'],
                    'href' => $this->url->link('collection/category', 'path=' . $this->request->get['path'] . $url)
                );
            }
        }
        ...
        if ($product_info) {
            ...
            $data['breadcrumbs'][] = array(
                ...
                'href' => $this->url->link('collection/product', $url . '&product_id=' . $this->request->get['product_id'])
            );

            $this->document->setTitle($product_info['meta_title']);
            $this->document->setDescription($product_info['meta_description']);
            $this->document->setKeywords($product_info['meta_keyword']);
            $this->document->addLink($this->url->link('collection/product', 'product_id=' . $this->request->get['product_id']), 'canonical');
            ...
            foreach ($results as $result) {
                ...
                $data['products'][] = array(
                    ...
                    'rating'      => $rating,
                    'href'        => $this->url->link('collection/product', 'product_id=' . $result['product_id'])
                );
            }
            ...
            if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/collection/product.tpl')) {
                ...
                $this->response->setOutput($this->load->view('default/template/collection/product.tpl', $data));
            }
        } else {
            $url = '';
            ...
            $data['breadcrumbs'][] = array(
                ...
                'href' => $this->url->link('collection/product', $url . '&product_id=' . $product_id)
            );
	...
	public function review() {
		...
		$pagination->limit = 5;
		$pagination->url = $this->url->link('collection/product/review', 'product_id=' . $this->request->get['product_id'] . '&page={page}');
